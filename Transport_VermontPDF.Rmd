...
# Analysis of adequacy of public transit and walkability in Vermont
...
Figure \@ref(fig:mapWalkability) shows walkability scores by Census Block Group across Vermont.  Walkability varies across the state, although most of the state is classified as below average to least walkable. Walkability is highest in portions of Burlington and Rutland.
...
```{r mapLAI, fig.align = "center", fig.cap="Transpotation cost burden for Census Tracts across Vermont."}
m <- tm_shape(lai_ri) +
...
Transportation cost burden varies for different population groups across the state. Figure \@ref(fig:loliLAI) below compares population-weighted average transportation cost burden for different populations. Most groups live in communities with transportation cost burdens that are above that of the general population. Persons over age 64 tend to live in communities with the highest transportation cost burdens. 

```{r loliLAI, fig.align = "center", fig.cap="Population-weighted average transportation cost burden for groups across Vermont."}
