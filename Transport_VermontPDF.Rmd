...
vt_travt_walkability_sf <- vt_blkgrp_walkability_sf %>% 
  as.data.frame() %>% 
...
vt_travt_walkability_df <- vt_travt_walkability_sf %>% 
  as.data.frame() %>% 
...
leastWalkableTract <- vt_travt_walkability_sf %>% 
  filter(NatWalkInd <= 5.8) %>% 
