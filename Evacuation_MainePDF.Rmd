...
me_state_sf_cb <- ne_states_sf_cb %>% 
  filter(NAME == "Maine") %>% 
  st_transform(., crs = st_crs(me_blkgrp_2802))

# save data for later analysis
save(me_blkgrps_nfhza,me_tracts_nfhza,
     file = "DATA/FEMA/ME/nfhza_census.Rds")
```
...
```{r mapNFHZAPop, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="FEMA flood zones across Maine."}
# Create a dot density map of total populations and overlay on flood zones
...
# }
# 
# # LimitEngHH_nfhza_pts <- pop2points(me_blkgrps_nfhza,NewEng_limit,"Limited English HH") # no blkgrps with 10 or more 
# 
...
# 
# Minor_nfhza_pts <- pop2points(me_blkgrps_nfhza,NewMinority,"Minority")
# 
# Under5_nfhza_pts <- pop2points(me_blkgrps_nfhza,NewUnder5,"Under 5")
# 
# Over64_nfhza_pts <- pop2points(me_blkgrps_nfhza,NewOver64,"Over 64")
# 
# Under18_nfhza_pts <- pop2points(me_blkgrps_nfhza,NewUnder18,"Under 18")
# 
# # Bring them together
...
#             legend.outside.position = c("right", "top"))
# 
# tmap_save(m2, "DATA/FEMA/ME/ME_nhfza_vulnerable1.png",
#           height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_nhfza_vulnerable1.png")
```

```{r mapNFHZAPopConcern2, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Persons Over 64 Living within Flood Zones."}
# # create pop subset
# nfhza_sub <- me_nfhza_vulnerable %>% 
...
#             legend.outside.position = c("right", "top"))
# 
# tmap_save(m2, "DATA/FEMA/ME/ME_nhfza_vulnerable2.png",
#           height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_nhfza_vulnerable2.png")
```
...
# save data for later analysis
save(me_blkgrps_hevac, me_tracts_hevac, 
     file = "DATA/FEMA/ME/hevac_census.Rds")
```

Maine is subject to hurricane risk. Since 1900, Maine has been struck by hurricanes four times. The most recent hurricane to hit Maine directly was [Hurricane Bob in 1991](https://www.mass.gov/service-details/the-worst-Maine-hurricanes-of-the-20th-century),[^HurricaneBob] a Category 2 storm that affected six counties in the southern and central part of the state. [The storm resulted in 3 deaths, power outages, and over $5 million in damages as well as a presidential disaster declaration](https://www.maine.gov/mema/hazards/natural-hazards/hurricanes).[^BobMaine] Hurricane Sandy in 2012 had been downgraded to a tropical storm by the time it hit Maine, but nevertheless [left 90,000 people across the state without power due to high winds](https://bangordailynews.com/2012/10/29/news/portland/hurricane-sandy-remains-unpredictable-for-maine-especially-islanders/).[^SandyME] In general, Maine is subject to a [hurricane return period of between 29 and 59 years, depending on the area](https://www.nhc.noaa.gov/climo/#returns).[^HurricaneReturn] 
...
```{r mapHEVACPop, fig.align = "center", fig.cap="Hurricane inundation zones across Maine."}
...
tmap_save(m, "DATA/FEMA/ME/ME_hevac.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_hevac.png")
```
...
Some groups are disproportionately exposed to these hurricane evacuation hazards. While approximately 4.5% of the general population are living within hurricane inundation zones, limited English speaking households and households without access to a car exceed the population average living within hurricane inundation zones. These priority populations are disproportionately exposed to hurricane inundation risk (see Figures \@ref(fig:chartHEVACpop) and \@ref(fig:mapHEVACPopConcern1) below).
...
# 
# NoHSdip_hevac_pts <- pop2points(me_blkgrps_hevac,NewLths,"No HS Dip")
# 
# LowInc_hevac_pts <- pop2points(me_blkgrps_hevac,NewPov,"Low Income")
# 
# Disabled_hevac_pts <- pop2points(me_tracts_hevac,NewDisabled,"Disabled")
# 
# Minor_hevac_pts <- pop2points(me_blkgrps_hevac,NewMinority,"Minority")
# 
# Under5_hevac_pts <- pop2points(me_blkgrps_hevac,NewUnder5,"Under 5")
# 
# Over64_hevac_pts <- pop2points(me_blkgrps_hevac,NewOver64,"Over 64")
# 
# Under18_hevac_pts <- pop2points(me_blkgrps_hevac,NewUnder18,"Under 18")
# 
# # Bring them together
# me_hevac_vulnerable <- rbind(NoCarHH_hevac_pts,
...
```{r mapHEVACPopConcern1, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Limited English Speaking Households Living within Hurricane Inundation Zones."}
# # Create data subset
# hevac_sub <- me_hevac_vulnerable %>% 
...
#             legend.title.size = 0.8)
# 
# tmap_save(m2, "DATA/FEMA/ME/ME_hevac_vulnerable1.png",
#           height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_hevac_vulnerable1.png")
```

```{r mapHEVACPopConcern2, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Households without a Car Living within Hurricane Inundation Zones."}
# # Create data subset
# hevac_sub <- me_hevac_vulnerable %>% 
#   filter(Group == "No Car HH")
# 
...
#             legend.title.size = 0.8)
# 
# tmap_save(m2, "DATA/FEMA/ME/ME_hevac_vulnerable2.png",
#           height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_hevac_vulnerable2.png")
```
...
#             legend.outside.position = c("right", "top"))
# 
# tmap_save(m2, "DATA/FEMA/ME/ME_nhfza_vulnerable3.png",
#           height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_nhfza_vulnerable3.png")
```
...
```{r mapNFHZAPopConcern4, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Low Income Persons Living within Flood Zones."}
# # create pop subset
# nfhza_sub <- me_nfhza_vulnerable %>% 
...
#             legend.outside.position = c("right", "top"))
# 
# tmap_save(m2, "DATA/FEMA/ME/ME_nhfza_vulnerable4.png",
#           height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_nhfza_vulnerable4.png")
```
...
```{r mapNFHZAPopConcern5, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Adults without a High School Diploma Living within Flood Zones."}
# # create pop subset
# nfhza_sub <- me_nfhza_vulnerable %>% 
...
#             legend.outside.position = c("right", "top"))
# 
# tmap_save(m2, "DATA/FEMA/ME/ME_nhfza_vulnerable5.png",
#           height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_nhfza_vulnerable5.png")
```
...
```{r mapNFHZAPopConcern6, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Persons Under 18 Living within Flood Zones."}
# # create pop subset
# nfhza_sub <- me_nfhza_vulnerable %>% 
...
#             legend.outside.position = c("right", "top"))
# 
# tmap_save(m2, "DATA/FEMA/ME/ME_nhfza_vulnerable6.png",
#           height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_nhfza_vulnerable6.png")
```
...
```{r mapNFHZAPopConcern7, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="People of Color Living within Flood Zones."}
# create pop subset
nfhza_sub <- me_nfhza_vulnerable %>%
...
tmap_save(m2, "DATA/FEMA/ME/ME_nhfza_vulnerable7.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_nhfza_vulnerable7.png")
```
...
#             legend.outside.position = c("right", "top"))
# 
# tmap_save(m2, "DATA/FEMA/ME/ME_nhfza_vulnerable8.png",
#           height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_nhfza_vulnerable8.png")
```
...
```{r tabHEVACLEH, fig.align = "center", fig.cap="Limited English speaking households living within Hurricane Inundation Zones."}
me_blkgrps_hevac %>% 
  st_centroid(.) %>% 
  st_intersection(me_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "Limited English Speaking Households Living in Hurricane Inundation Zones", align = "r") %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```

```{r tabHEVACNoCar, fig.align = "center", fig.cap="Households without a car living within Hurricane Inundation Zones."}
me_tracts_hevac %>% 
  st_centroid(.) %>% 
  st_intersection(me_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "Households without a Car Living in Hurricane Inundation Zones", align = "r") %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
```

```{r mapHEVACPopConcern3, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="People of Color Persons Living within Hurricane Inundation Zones."}
# Create data subset
hevac_sub <- me_hevac_vulnerable %>%
  filter(Group == "Minority")
...
tmap_save(m2, "DATA/FEMA/ME/ME_hevac_vulnerable3.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_hevac_vulnerable3.png")
```

```{r tabHEVACMIN, fig.align = "center", fig.cap="People of Color living within Hurricane Inundation Zones."}
me_blkgrps_hevac %>% 
  st_centroid(.) %>% 
  st_intersection(me_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "People of Color Living in Hurricane Inundation Zones", align = "r", col.names = c("City/Town", "People of Color", "Pct of POC")) %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```

```{r mapHEVACPopConcern4, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Persons Over 64 Living within Hurricane Inundation Zones."}
# # Create data subset
# hevac_sub <- me_hevac_vulnerable %>% 
#   filter(Group == "Over 64")
# 
...
#             legend.title.size = 0.8)
# 
# tmap_save(m2, "DATA/FEMA/ME/ME_hevac_vulnerable4.png",
#           height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_hevac_vulnerable4.png")
```

```{r tabHEVACO64, fig.align = "center", fig.cap="Persons over 64 living within Hurricane Inundation Zones."}
me_blkgrps_hevac %>% 
  st_centroid(.) %>% 
  st_intersection(me_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "Persons Over 64 Living in Hurricane Inundation Zones", align = "r") %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
```

```{r mapHEVACPopConcern5, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Disabled Persons Living within Hurricane Inundation Zones."}
# # Create data subset
# hevac_sub <- me_hevac_vulnerable %>% 
#   filter(Group == "Disabled")
# 
...
#             legend.title.size = 0.8)
# 
# tmap_save(m2, "DATA/FEMA/ME/ME_hevac_vulnerable5.png",
#           height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_hevac_vulnerable5.png")
```

```{r tabHEVACDIS, fig.align = "center", fig.cap="Disabled persons living within Hurricane Inundation Zones."}
me_tracts_hevac %>% 
  st_centroid(.) %>% 
  st_intersection(me_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "Disabled Persons Living in Hurricane Inundation Zones", align = "r") %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
```

```{r mapHEVACPopConcern6, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Low Income Persons Living within Hurricane Inundation Zones."}
# # Create data subset
# hevac_sub <- me_hevac_vulnerable %>% 
#   filter(Group == "Low Income")
# 
...
#             legend.title.size = 0.8)
# 
# tmap_save(m2, "DATA/FEMA/ME/ME_hevac_vulnerable6.png",
#           height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_hevac_vulnerable6.png")
```

```{r tabHEVACLINC, fig.align = "center", fig.cap="Low income persons living within Hurricane Inundation Zones."}
me_blkgrps_hevac %>% 
  st_centroid(.) %>% 
  st_intersection(me_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "Low Income Persons Living in Hurricane Inundation Zones", align = "r") %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
```

```{r mapHEVACPopConcern7, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Children Under 5 Living within Hurricane Inundation Zones."}
# # Create data subset
# hevac_sub <- me_hevac_vulnerable %>% 
#   filter(Group == "Under 5")
# 
...
#             legend.title.size = 0.8)
# 
# tmap_save(m2, "DATA/FEMA/ME/ME_hevac_vulnerable7.png",
#           height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_hevac_vulnerable7.png")
```

```{r tabHEVACU5, fig.align = "center", fig.cap="Children under 5 living within Hurricane Inundation Zones."}
me_blkgrps_hevac %>% 
  st_centroid(.) %>% 
  st_intersection(me_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "Children Under 5 Living in Hurricane Inundation Zones", align = "r") %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
```

```{r mapHEVACPopConcern8, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Adults without a High School Diploma Living within Hurricane Inundation Zones."}
# Create data subset
# hevac_sub <- me_hevac_vulnerable %>% 
#   filter(Group == "No HS Dip")
# 
...
#             legend.title.size = 0.8)
# 
# tmap_save(m2, "DATA/FEMA/ME/ME_hevac_vulnerable8.png",
#           height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_hevac_vulnerable8.png")
```

```{r tabHEVACLTHS, fig.align = "center", fig.cap="Adults without a high school diploma living within Hurricane Inundation Zones."}
me_blkgrps_hevac %>% 
  st_centroid(.) %>% 
  st_intersection(me_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "Adults wihtout a High School Diploma Living in Hurricane Inundation Zones", align = "r") %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
```

```{r mapHEVACPopConcern9, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Persons Under 18 Living within Hurricane Inundation Zones."}
# # Create data subset
# hevac_sub <- me_hevac_vulnerable %>% 
#   filter(Group == "Under 18")
# 
...
#             legend.title.size = 0.8)
# 
# tmap_save(m2, "DATA/FEMA/ME/ME_hevac_vulnerable9.png",
#           height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/ME/ME_hevac_vulnerable9.png")
```

```{r tabHEVACU18, fig.align = "center", fig.cap="Persons under 18 living within Hurricane Inundation Zones."}
me_blkgrps_hevac %>% 
  st_centroid(.) %>% 
  st_intersection(me_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "Persons Under 18 Living in Hurricane Inundation Zones", align = "r") %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
```
