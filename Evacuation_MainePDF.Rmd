...
tm_layout(bg.color = "#e6f3f7") +
  ...
  tm_fill(col = "Interval", 
          ...
          alpha = 0.8,
          border.alpha = 0) +
  tm_shape(ne_states_sf_cb) + tm_borders(lwd = 0.7) +
...
```{r tabNFHZApop, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Maine Populations within Flood Zones."}
...
me_FloodPops_df %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','),
                    caption = "Maine Populations within Flood Zones",
                    digits = 0, align = "r") %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header"))
```

Some groups are disproportionately exposed to these flood hazards. While approximately 2.4% of the general population are within flood zones, households without access to a car, individuals over age 64, people with disabilities, people in low income households, and other populations of concern, exceed the population average within flood zones. These populations of concern are overrepresented in terms of flood exposure (see Figure \@ref(fig:chartNFHZApop) below).

```{r chartNFHZApop, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Maine Populations within Flood Zones."}
...
me_FloodPops_df %>% 
  ...
  ggtitle("Maine Populations within Flood Zones") + theme_light() +
...
```{r mapNFHZAPopConcern, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Maine Populations within Flood Zones."}
...
#             asp = 10/15)
# 
# tmap_save(m, "DATA/FEMA/ME/ME_nhfza_vulnerable.png",
...
me_HevacPops_df %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','),
                    caption = "Maine Populations within Hurricane Inundation Zones",
                    digits = 0, align = "r") %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header"))
```
...
```{r chartHEVACpop, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Maine Populations within Hurricane Inundation Zones."}
# Create lollipop plot of pops within flood zones
me_HevacPops_df %>% 
  ...
  geom_point(color = "blue", size = 4, alpha = 0.8) +
  coord_flip() + xlab("") + ylab("") + 
  ggtitle("Maine Populations within Hurricane Inundation\nZones") + theme_light() +
  theme(panel.grid.major.y = element_blank(),
        panel.border = element_blank(),
        axis.ticks.y = element_blank()) +
...
```{r mapHEVACPopConcern, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Maine Populations within Hurricane Inundation Zones."}
