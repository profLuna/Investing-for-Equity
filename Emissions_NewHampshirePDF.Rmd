...
There is a moderate positive correlation between the proportions of minorities and ambient concentrations of Diesel Particulate Matter (see Figure \@ref(fig:cormatrixDPMPopAvg) in Appendix B).
...
In addition to variations in the general geography of cancer risk, exposure to these risks also varies demographically. Figure \@ref(fig:barplotATCPopAvg) below shows population-weighted exposures for populations of concern relative to average cancer risk for the state. For example, limited English speaking households in New Hampshire experience  cancer risks from inhalation of air toxics that are more than 14% above the state as a whole. Similarly, minorities experience  cancer risks more than 8% above the state average. By contrast, persons over age 64 are exposed to risks 1.2% below the state average. 
...
In addition to variations in the general geography of the respiratory hazard index, exposure to these risks also varies demographically. Figure \@ref(fig:barplotRHIPopAvg) below shows population-weighted exposures for populations of concern relative to average respiratory hazard index for the state. For example, limited English speaking households in New Hampshire experience respiratory hazard indices that are over 15% above the state as a whole. Similarly, minorities experience respiratory hazard index values more than 9% above the state average. By contrast, persons over age 64 are exposed to an average hazard index below the state average. 
...
There is a moderate positive correlation between the proportions of minorities and respiratory hazard index (see Figure \@ref(fig:cormatrixRHIPopAvg) in Appendix B).
...
ggsave("DATA/EJSCREEN/nh_traffic_lolli.png")
```
