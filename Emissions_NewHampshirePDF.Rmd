...
In addition to variations in the general geography of cancer risk, exposure to these risks also varies demographically. Figure \@ref(fig:barplotATCPopAvg) below shows population-weighted exposures for populations of concern relative to average cancer risk for the state. For example, limited English speaking households in New Hampshire experience  cancer risks from inhalation of air toxics that are more than 13% above the state as a whole. Similarly, minorities experience  cancer risks more than 8% above the state average. By contrast, persons over age 64 are exposed to risks 1.2% below the state average. 
