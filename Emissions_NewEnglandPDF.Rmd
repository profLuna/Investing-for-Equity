...
All populations of concern, except for persons over age 64, are much more exposed to CO~2~ emissions. There is a moderately positive correlation between the minorities, language isolated households, and emissions of CO~2~ per square kilometer (see Figure \@ref(fig:cormatrixCO2PopAvg) below.).
