...
```{r tabNFHZApop, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Rhode Island Populations Living within Flood Zones."}
...
```{r chartNFHZApop, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Rhode Island Populations Living within Flood Zones."}
...
The map below (Figure \@ref(fig:mapNFHZAPopConcern)) shows those populations that are disproportionately exposed to flood risk.
...
#             asp = 10/15)
# 
# tmap_save(m2, "DATA/FEMA/RI/RI_flood_vulnerable.png",
#           height = 6, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/RI/RI_flood_vulnerable.png")
```
...
\pagebreak
```{r tabHEVACpop, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Rhode Island Populations Living within Hurricane Evacuation Zones."}
# Show table of pops within flood zones
...
```{r chartHEVACpop, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Rhode Island Populations Living within Hurricane Evacuation Zones."}
# Create lollipop plot of pops within flood zones
...
The map below (Figure \@ref(fig:mapHEVACPopConcern)) shows those that are disproportionately exposed to hurricane evacuation risk.

```{r mapHEVACPopConcern, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Rhode Island Populations Living within Hurricane Evacuation Zones."}
...
#             asp = 10/15)
# 
# tmap_save(m4, "DATA/FEMA/RI/RI_hevac_vulnerable.png",
#           height = 6, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/RI/RI_hevac_vulnerable.png")
```
