...
ggsave("images/MA_UHI24_graph.png")
```


```{r tabUHI24hrPopAvgMA, fig.align = "center", fig.cap="Population-weighted average exposures to day-night average Urban Heat Island effect for priority populations in Massachusetts relative to the rural average."}
UHI24hrPopTab %>% 
  mutate(Group = recode(Group, "Minority" = "People of Color",
                        "MA Minority" = "MA POC")) %>%
  arrange(Group) %>% 
...
```{r mapLST24hrHighRiskMAMIN, fig.align = "center", fig.cap="Map of Block Groups in the highest quintile (80th percentile) of day-night average LST and 80th percentile of percentage of People of Color, as defined by Massachusetts Environmental Justice Policy, by Census Block Group, July-Aug 2019."}
...
\pagebreak
```{r tabLST24hrHighRiskMAMIN, fig.align = "center", fig.cap="People of Color in Census Block Groups at or above 80th percentile of day-night average Land Surface Temperature."}
...
LST24MinorityMA5 %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "MA People of Color in Highest Quintile of Day-Night Avg LST by Municipality", align = "r",
                    col.names = c(names(.)[1:2], "MA POC*", "Pct of MA POC", names(.)[5:7])) %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) %>% 
  kableExtra::column_spec(2:4, width = "3cm") %>%
  kableExtra::add_header_above(c(" " = 4, "Day-Night LST (°F)" = 3)) %>% 
  kableExtra::footnote(., symbol = "As defined by Massachusetts Environmental Justice Policy")
...
In addition to variations in the general geography of Land Surface Temperatures (LST), temperature exposure also varies demographically. Figure \@ref(fig:plotLSTDayTempPopAvgMA) and Table \@ref(tab:tabLSTDayPopAvgMA) show population-weighted exposures for priority populations relative to the average daytime average LST for the state, which is `r round(mean(ma_blkgrpLST_sf$meanDayLST,na.rm=TRUE),1)`°. For example, limited English speaking households in Massachusetts, as defined by the state's environmental justice policy, were exposed to a population-weighted daytime average LST of `r round(max(LSTDayPop$LSTDaywMean),1)`°, approximately `r round(max(LSTDayPop$LSTDaywMean) - max(LSTDayPop$LSTDayMean),1)`° (`r LSTDayPopTab[3,4]`) above the state daytime average LST. Similarly, People of Color, as defined by the state's environmental justice policy, were exposed to a population-weighted daytime average LST of approximately `r LSTDayPop %>% filter(Group == "MA Minority") %>% summarize(round(max(LSTDaywMean),1)) %>% pull()`°, `r round(LSTDayPop %>% filter(Group == "MA Minority") %>% summarize(max(LSTDaywMean)) %>% pull() - LSTDayPop %>% summarize(max(LSTDayMean)) %>% pull(),1)`° (`r LSTDayPopTab[5,4]`) above the state daytime average LST. By contrast, persons over age 64 were, on average, exposed to population-weighted daytime average LSTs of `r LSTDayPop %>% filter(Group == "Over 64") %>% summarize(round(max(LSTDaywMean),1)) %>% pull()`°, approximately `r LSTDayPopTab[8,3]` below the state average.

```{r plotLSTDayTempPopAvgMA, fig.align = "center", fig.cap="Population-weighted average exposures to average daytime Land Surface Temperatures for priority populations in Massachusetts relative to the state average."}
LSTDayPop %>% 
  mutate(Group = recode(Group, "Minority" = "People of Color",
                        "MA Minority" = "MA POC")) %>% 
...
ggsave("images/MA_LSTDay_graph.png")
```

\pagebreak
```{r tabLSTDayPopAvgMA, fig.align = "center", fig.cap="Population-weighted average exposures to Daytime LST for priority populations in Massachusetts relative to the state average."}
LSTDayPopTab %>% 
  mutate(Group = recode(Group, "Minority" = "People of Color",
                        "MA Minority" = "MA POC")) %>%
  arrange(Group) %>% 
...
ggsave("images/MA_UHIDay_graph.png")
```


```{r tabUHIDayPopAvgMA, fig.align = "center", fig.cap="Population-weighted average exposures to daytime Urban Heat Island effect for priority populations in Massachusetts relative to the rural average."}
UHIDayPopTab %>% 
  mutate(Group = recode(Group, "Minority" = "People of Color",
                        "MA Minority" = "MA POC")) %>%
  arrange(Group) %>% 
...
Because the risk of heat-related illness is a combination of both exposure and vulnerability, it is important to consider where these factors come together. Figures \@ref(fig:mapLSTDayHighRiskMALEH) and \@ref(fig:mapLSTDayHighRiskMAMIN) highlight Census Block Groups across Massachusetts which exhibited daytime average LSTs in the top quintile (i.e., 80th percentile) and were categorized as Environmental Justice communities for limited English speaking households or People of Color.[^Dayquintile] Approximately `r LEHDay %>% format(., big.mark = ",") %>% pull()` limited English speaking households and `r MINDay %>% format(., big.mark = ",") %>% pull()` People of Color were resident in these highest quintile Block Groups. These numbers represent `r LEHDayPct`% and `r MINDayPct`%, respectively, of those populations in the state. By comparison, `r HHDayPct`% of all households, and `r PopDayPct`% of the general population were resident in these same Block Groups.  

Tables \@ref(tab:tabLSTDayHighRiskMALEH) and \@ref(tab:tabLSTDayHighRiskMAMIN) show breakdowns by municipality of the numbers of limited English speaking households and People of Color resident in these top quintile Block Groups. Maps and tables for other priority populations can be found in Figures \@ref(fig:mapLSTDayHighRiskLEH) to \@ref(fig:mapLSTDayHighRiskU5) and Tables \@ref(tab:tabLSTDayHighRiskLEH) to \@ref(tab:tabLSTDayHighRiskU5) in Appendix B.
...
```{r mapLSTDayHighRiskMAMIN, fig.align = "center", fig.cap="Map of Block Groups in the highest quintile (80th percentile) of daytime average LST and 80th percentile of percentage of People of Color, as defined by Massachusetts Environmental Justice Policy, by Census Block Group, July-Aug 2019."}
...
```
\pagebreak
```{r tabLSTDayHighRiskMAMIN, fig.align = "center", fig.cap="People of Color in Census Block Groups at or above 80th percentile of daytime average Land Surface Temperature."}
LSTDayMinorityMA5 %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "MA People of Color in Highest Quintile of Daytime Avg LST by Municipality", align = "r",
                    col.names = c(names(.)[1:2], "MA POC*", "Pct of MA POC", names(.)[5:7])) %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) %>% 
  kableExtra::column_spec(2:4, width = "3cm") %>%
  kableExtra::add_header_above(c(" " = 4, "Daytime LST (°F)" = 3)) %>% 
...
In addition to variations in the general geography of Land Surface Temperatures (LST), temperature exposure also varies demographically. Figure \@ref(fig:plotLSTNightTempPopAvgMA) and Table \@ref(tab:tabLSTNightPopAvgMA) show population-weighted exposures for priority populations relative to the average nighttime average LST of `r round(mean(ma_blkgrpLST_sf$meanNightLST,na.rm=TRUE),1)`° for the state. For example, limited English speaking households in Massachusetts, as defined by the state's environmental justice policy, were exposed to a population-weighted nighttime average LST of `r round(max(LSTNightPop$LSTNightwMean),1)`°, approximately `r round(max(LSTNightPop$LSTNightwMean) - max(LSTNightPop$LSTNightMean),1)`° (`r LSTNightPopTab[3,4]`) above the state nighttime average LST. Similarly, People of Color, as defined by the state's environmental justice policy, were exposed to a population-weighted nighttime average LST of `r LSTNightPop %>% filter(Group == "MA Minority") %>% summarize(round(max(LSTNightwMean),1)) %>% pull()`°, over `r round(LSTNightPop %>% filter(Group == "MA Minority") %>% summarize(max(LSTNightwMean)) %>% pull() - max(LSTNightPop$LSTNightMean),1)`° (`r LSTNightPopTab[5,4]`) above the state nighttime average LST. By contrast, persons over age 64 were, on average, exposed to population-weighted nighttime average LSTs of `r LSTNightPopTab[8,2]`, approximately `r LSTNightPopTab[8,3]` below the state average.

```{r plotLSTNightTempPopAvgMA, fig.align = "center", fig.cap="Population-weighted average exposures to average nighttime Land Surfact Temperatures for priority populations in Massachusetts relative to the state average."}
LSTNightPop %>% 
  mutate(Group = recode(Group, "Minority" = "People of Color",
                        "MA Minority" = "MA POC")) %>% 
...
ggsave("images/MA_LSTNight_graph.png")
```

\pagebreak
```{r tabLSTNightPopAvgMA, fig.align = "center", fig.cap="Population-weighted average exposures to nighttime LST for priority populations in Massachusetts relative to the state average."}
LSTNightPopTab %>% 
  mutate(Group = recode(Group, "Minority" = "People of Color",
                        "MA Minority" = "MA POC")) %>%
  arrange(Group) %>% 
...
```{r tabUHINightPopAvgMA, fig.align = "center", fig.cap="Population-weighted average exposures to nighttime Urban Heat Island effect for priority populations in Massachusetts relative to the rural average."}
UHINightPopTab %>% 
  mutate(Group = recode(Group, "Minority" = "People of Color",
                        "MA Minority" = "MA POC")) %>%
  arrange(Group) %>% 
...
Because the risk of heat-related illness is a combination of both exposure and vulnerability, it is important to consider where these factors come together. Figures \@ref(fig:mapLSTNightHighRiskMALEH) and \@ref(fig:mapLSTNightHighRiskMAMIN) highlight Census Block Groups across Massachusetts which exhibited day-night average LSTs in the top quintile (i.e., 80th percentile) and were also designated as Environmental Justice communities for limited English speaking households or People of Color.[^Nightquintile] Approximately `r LEHNight %>% format(., big.mark = ",") %>% pull()` limited English speaking households and `r MINNight %>% format(., big.mark = ",") %>% pull()` People of Color were resident in these highest quintile Block Groups. These numbers represent `r LEHNightPct`% and `r MINNightPct`%, respectively, of those populations in the state. By comparison, `r HHNightPct`% of all households, and `r PopNightPct`% of the general population were resident in these same Block Groups. 

Tables \@ref(tab:tabLSTNightHighRiskMALEH) and \@ref(tab:tabLSTNightHighRiskMAMIN) show breakdowns by municipality of how many limited English speaking households and People of Color these represent, and the day-night average LST values for those same Census Block Groups. Maps and tables for other priority populations can be found in Figures \@ref(fig:mapLSTNightHighRiskLEH) to \@ref(fig:mapLSTNightHighRiskU5) and Tables \@ref(tab:tabLSTNightHighRiskLEH) to \@ref(tab:tabLSTNightHighRiskU5) in Appendix B.
...
```{r mapLSTNightHighRiskMAMIN, fig.align = "center", fig.cap="Map of Block Groups in the highest quintile (80th percentile) of nighttime average LST and 80th percentile of percentage of People of Color, as defined by Massachusetts Environmental Justice Policy, by Census Block Group, July-Aug 2019."}
...
```
\pagebreak
```{r tabLSTNightHighRiskMAMIN, fig.align = "center", fig.cap="People of Color in Census Block Groups at or above 80th percentile of Nighttime average Land Surface Temperature."}
LSTNightMinorityMA5 %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "MA People of Color in Highest Quintile of Nighttime Avg LST by Municipality", align = "r",
                    col.names = c(names(.)[1:2], "MA POC*", "Pct of MA POC", names(.)[5:7])) %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) %>% 
  kableExtra::column_spec(2:4, width = "3cm") %>%
  kableExtra::add_header_above(c(" " = 4, "Night LST (°F)" = 3)) %>% 
...
LST24Minority5 %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "People of Color in Highest Quintile of Day-Night Avg LST by Municipality", align = "r", col.names = c("City/Town", "People of Color", "Pct of POC")) %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) %>% 
  kableExtra::column_spec(2:4, width = "3cm") %>%
  kableExtra::add_header_above(c(" " = 4, "Day-Night LST (°F)" = 3))
```
...
LSTDayMinority5 %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "People of Color in Highest Quintile of Daytime Avg LST by Municipality", align = "r", col.names = c("City/Town", "People of Color", "Pct of POC")) %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) %>% 
  kableExtra::column_spec(2:4, width = "3cm") %>%
  kableExtra::add_header_above(c(" " = 4, "Day LST (°F)" = 3))
```
...
LSTNightMinority5 %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "People of Color in Highest Quintile of Nighttime Avg LST by Municipality", align = "r", col.names = c("City/Town", "People of Color", "Pct of POC")) %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) %>% 
  kableExtra::column_spec(2:4, width = "3cm") %>%
  kableExtra::add_header_above(c(" " = 4, "Night LST (°F)" = 3))
```
...
```{r cormatrixLSTpopsMA, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Spearman's correlation matrix of temperature and the proportions of priority populations by Census Block Group."}
