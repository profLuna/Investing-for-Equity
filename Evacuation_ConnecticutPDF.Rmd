...
```{r mapNFHZAPopConcern, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Rhode Island Populations Living within Flood Zones."}
...
#             asp = 14/10)
# 
# tmap_save(m, "DATA/FEMA/CT/CT_nhfza_vulnerable.png",
#           height = 9, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/CT/CT_nhfza_vulnerable.png")
```
...
#             asp = 14/10)
# 
# tmap_save(m2, "DATA/FEMA/CT/CT_hevac_vulnerable.png",
#           height = 9, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/CT/CT_hevac_vulnerable.png")
```
