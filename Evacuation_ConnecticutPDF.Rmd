...
The maps below (Figure \@ref(fig:mapNFHZAPopConcern)) show those populations that are disproportionately exposed to flood risk.
...
```{r mapNFHZAPopConcern2, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Low Income Persons, as Defined by the Connecticut Environmental Justice Policy, Living within Flood Zones."}
nfhza_sub <- ct_nfhza_vulnerable %>% 
...
```{r mapHEVACPopConcern1, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Households without a Car Living within Hurricane Evacuation Zones."}
# Create data subset
...
```{r mapHEVACPopConcern2, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Low Income Persons, as Defined by the Connecticut Environmental Justice Policy, Living within Hurricane Evacuation Zones."}
# Create data subset
hevac_sub <- ct_hevac_vulnerable %>% 
  filter(Group == "CT Low Income")
...
```{r mapNFHZAPopConcern3, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Limited English Speaking Households Living within Flood Zones."}
# Create data subset
nfhza_sub <- ct_nfhza_vulnerable %>% 
...
```{r mapNFHZAPopConcern5, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Disabled Persons Living within Flood Zones."}
# Create data subset
nfhza_sub <- ct_nfhza_vulnerable %>% 
...
```{r mapNFHZAPopConcern6, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Low Income Persons Living within Flood Zones."}
# Create data subset
nfhza_sub <- ct_nfhza_vulnerable %>% 
...
```{r mapNFHZAPopConcern7, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Minority Persons Living within Flood Zones."}
# Create data subset
nfhza_sub <- ct_nfhza_vulnerable %>% 
...
```{r mapNFHZAPopConcern9, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Persons Over 64 Living within Flood Zones."}
# Create data subset
nfhza_sub <- ct_nfhza_vulnerable %>% 
...
```{r mapNFHZAPopConcern10, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Persons Under 18 Living within Flood Zones."}
# Create data subset
nfhza_sub <- ct_nfhza_vulnerable %>% 
...
```{r mapHEVACPopConcern3, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Limited English Speaking Households Living within Hurricane Evacuation Zones."}
# Create data subset
hevac_sub <- ct_hevac_vulnerable %>% 
  filter(Group == "Limited English HH")
...
```{r mapHEVACPopConcern5, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Disabled Persons Living within Hurricane Evacuation Zones."}
# Create data subset
hevac_sub <- ct_hevac_vulnerable %>% 
  filter(Group == "Disabled")
...
```{r mapHEVACPopConcern6, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Low Income Persons Living within Hurricane Evacuation Zones."}
# Create data subset
hevac_sub <- ct_hevac_vulnerable %>% 
  filter(Group == "Low Income")
...
```{r mapHEVACPopConcern7, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Minority Persons Living within Hurricane Evacuation Zones."}
# Create data subset
hevac_sub <- ct_hevac_vulnerable %>% 
  filter(Group == "Minority")
...
```{r mapHEVACPopConcern9, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Persons Over 64 Living within Hurricane Evacuation Zones."}
# Create data subset
hevac_sub <- ct_hevac_vulnerable %>% 
  filter(Group == "Over 64")
...
```{r mapHEVACPopConcern10, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Persons Under 18 Living within Hurricane Evacuation Zones."}
# Create data subset
hevac_sub <- ct_hevac_vulnerable %>% 
  filter(Group == "Under 18")
