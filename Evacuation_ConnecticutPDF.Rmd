...
ggsave("DATA/FEMA/CT/ct_hevac_lolli.png")
```
...
```{r mapNFHZAPopConcern7, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Minority Persons Living within Flood Zones."}
# Create data subset
nfhza_sub <- ct_nfhza_vulnerable %>% 
...
```{r mapHEVACPopConcern7, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Minority Persons Living within Hurricane Evacuation Zones."}
# Create data subset
hevac_sub <- ct_hevac_vulnerable %>% 
  filter(Group == "Minority")
