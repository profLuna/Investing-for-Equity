...
```{r mapNFHZAPop, fig.align = "center", fig.cap="FEMA flood zones and population distribution across Vermont at Census Block Group level."}
# Create a dot density map of total populations and overlay on flood zones
...
ggsave("DATA/FEMA/VT/vt_flood_lolli.png")
...
```{r mapNFHZAPopConcern5, fig.align = "center", fig.cap="Minority Persons Living within Flood Zones."}
# create pop subset
nfhza_sub <- vt_nfhza_vulnerable %>% 
