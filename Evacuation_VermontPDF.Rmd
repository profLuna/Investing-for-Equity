...
The maps below (Figure \@ref(fig:mapNFHZAPopConcern)) show those groups disproportionately exposed to flood risk.

```{r mapNFHZAPopConcern, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Vermont Populations Living within Flood Zones."}
