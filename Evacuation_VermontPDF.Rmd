...
# create a pattern layer to show river corridors. See https://rpubs.com/dieghernan/559092 
# load function
source("resources/cartography/patternLayer.R")
rc_layer <- rc %>% 
  st_cast(., "MULTIPOLYGON") %>% 
  patternLayer(., pattern = "right2left")
