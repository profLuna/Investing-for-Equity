...
vt_nfhza_2852_land %>% 
  ...
  footnote(general = "There is significant spatial overlap between FEMA flood zones and river corridors. Approximately 50%\nof river corridor areas overlap with FEMA flood zones in areas\nwhere there is both FEMA and river corridor data. Conversely, 48% of FEMA\nflood zones overlap with river corridors.")
```
