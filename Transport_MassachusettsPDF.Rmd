...
ggsave("DATA/transport/MA/figures/ma_BusHeadway_lolli.png")
```
...
ggsave("DATA/transport/MA/figures/ma_walk_lolli.png")
```
...
ggsave("DATA/transport/MA/figures/ma_tburden_lolli.png")
```
