...
# Analysis of adequacy of public transit and walkability in Massachusetts
...
mbta_busRoutes_sf <- st_read(dsn = "DATA/transport/mbtabus",
...
mbta_busStops_sf <- st_read(dsn = "DATA/transport/mbtabus",
...
mbta_rtRoutes_sf <- st_read(dsn = "DATA/transport/mbta_rapid_transit",
                           layer = "MBTA_ARC")

# read in MBTA rapid transit stops
mbta_rtStops_sf <- st_read(dsn = "DATA/transport/mbta_rapid_transit",
                           layer = "MBTA_NODE") %>% 
...
mbta_trainRoutes_sf <- st_read("DATA/transport/mbta_trains",
                             layer = "TRAINS_ARC") %>% 
...
mbta_trainStops_sf <- st_read("DATA/transport/mbta_trains",
                             layer = "TRAINS_NODE") %>% 
...
ma_busRoutes_sf <- st_read("DATA/transport/MA_Regional_Transit_Authorities_Routes-shp", layer = "Regional_Transit_Authorities") %>% 
...
ma_busStops_sf <- st_read("DATA/transport/MA_Regional_Transit_Authorities_Stops-shp", layer = "Regional_Transit_Authorities") %>% 
  st_transform(., crs = st_crs(mbta_busRoutes_sf)) %>% 
  transmute(STOP_NAME = stop_name,
            AGENCY = Agency,
            TYPE = "Bus")
...
# ma_ferryRoutes_sf <- st_read("DATA/transport/MA_Ferry_Routes-shp",
#                              layer = "Ferry_Routes") %>% 
#   filter(TYPE == "pass" & SERVICE == "year round") %>% 
#   st_transform(., crs = st_crs(mbta_busRoutes_sf))
# 
# # read in MA seaports
# ma_seaports_sf <- st_read("DATA/transport/MA_Seaports-shp", 
#                           layer = "Seaports") %>% 
...
ma_parknride_sf <- st_read(dsn = "DATA/transport/MA_Park_and_Ride_Lots-shp",
...
regional public transit agencies, as well as a number of private operators. These transit services include buses, rapid transit (i.e., subway or light rail), commuter rail, and park-in-ride lots served by public and private buses or shuttles. Amtrak train service passes through Massachusetts as well, but it is only considered with respect to commuter rail service. Ferry services, water taxis, and other seasonal transportation services are not considered in this analysis. Figure \@ref(fig:transitMap) shows `r formatC(nrow(ma_busRoutesAll_sf),big.mark = ",")` fixed public transit routes across the state along with population density.
...
# 
# tmap_save(m, "DATA/transport/ma_transit.png",
#           height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_transit.png")
```
...
```{r statsTransitDist, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Massachusetts populations living within 1/4 mile (400 meters) of a bus stop. Based on ACS 2017 Block Group data."}
...
ma_transitAccessPops_df %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T, 
                    ...
                    col.names = c("Group","MA Pop","Bus","Rapid Transit","Commuter Rail*","Any Transit","Bus","Rapid Transit","Commuter Rail*","Any Transit")) %>% 
  kableExtra::column_spec(3:10, width = "2cm") %>%
  kableExtra::add_header_above(c(" " = 2, "Total Pop with Access" = 4, "Pct Pop with Access" = 4)) %>% 
  kableExtra::footnote(general = "Access is 1/4 mile (400m) from bus stop, 1/2 mile (800m) from rapid transit stop, or 3 miles (4800m) from commuter rail stop.", symbol = "Commuter Rail includes Park-in-Ride lots") %>% 
...
tmap_save(m, "DATA/transport/ma_busO64access.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_busO64access.png")
```
...
#             legend.outside.position = c("right", "top"))
# 
# tmap_save(m, "DATA/transport/ma_RTO64access.png",
#           height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_RTO64access.png")
```
...
#             legend.outside.position = c("right", "top"))
# 
# tmap_save(m, "DATA/transport/ma_CRPRO64access.png",
#           height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_CRPRO64access.png")
```
...
tmap_save(m, "DATA/transport/ma_transitO64access.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_transitO64access.png")
```
...
#   pull()
# 
# download.file(mbtaGTFSurl,"DATA/transport/MA_gtfs_files/mbta_transit.zip")
# download.file(url = "http://data.trilliumtransit.com/gtfs/berkshire-ma-us/berkshire-ma-us.zip", "DATA/transport/MA_gtfs_files/berkshireRTA.zip")
# download.file(url = "http://data.trilliumtransit.com/gtfs/brockton-ma-us/brockton-ma-us.zip", "DATA/transport/MA_gtfs_files/brocktonRTA.zip")
# download.file(url = "http://data.trilliumtransit.com/gtfs/capeann-ma-us/capeann-ma-us.zip", "DATA/transport/MA_gtfs_files/capeannRTA.zip")
# download.file(url = "http://data.trilliumtransit.com/gtfs/capecod-ma-us/capecod-ma-us.zip", "DATA/transport/MA_gtfs_files/capecodRTA.zip")
# download.file(url = "http://data.trilliumtransit.com/gtfs/gatra-ma-us/gatra-ma-us.zip", "DATA/transport/MA_gtfs_files/tauntonattleboroRTA.zip")
# download.file(url = "http://data.trilliumtransit.com/gtfs/lowell-ma-us/lowell-ma-us.zip", "DATA/transport/MA_gtfs_files/lowellRTA.zip")
# download.file(url = "http://data.trilliumtransit.com/gtfs/merrimackvalley-ma-us/merrimackvalley-ma-us.zip", "DATA/transport/MA_gtfs_files/merrimackvalleyRTA.zip")
# download.file(url = "http://vc.mwrta.com/gtfs/google_transit.zip", "DATA/transport/MA_gtfs_files/metrowestRTA.zip")
# download.file(url = "http://data.trilliumtransit.com/gtfs/montachusett-ma-us/montachusett-ma-us.zip", "DATA/transport/MA_gtfs_files/montachusettRTA.zip")
# download.file(url = "http://data.trilliumtransit.com/gtfs/nantucket-ma-us/nantucket-ma-us.zip", "DATA/transport/MA_gtfs_files/nantucketRTA.zip")
# download.file(url = "http://www.pvta.com/g_trans/google_transit.zip", "DATA/transport/MA_gtfs_files/pioneervalleyRTA.zip")
# download.file(url = "http://data.trilliumtransit.com/gtfs/srta-ma-us/srta-ma-us.zip", "DATA/transport/MA_gtfs_files/southeasternRTA.zip")
# download.file(url = "http://data.trilliumtransit.com/gtfs/marthasvineyard-ma-us/marthasvineyard-ma-us.zip", "DATA/transport/MA_gtfs_files/vineyardTA.zip")
# download.file(url = "http://data.trilliumtransit.com/gtfs/wrta-ma-us/wrta-ma-us.zip", "DATA/transport/MA_gtfs_files/worcesterRTA.zip")

# Process MBTA GTFS separately because it errors out
mbta_transit <- read_gtfs("DATA/transport/MA_gtfs_files/mbta_transit.zip")
...
fileList <- as.list(list.files("DATA/transport/MA_gtfs_files/", pattern = ".zip", full.names = TRUE))
...
#             legend.outside.position = c("right", "top"))
# 
# tmap_save(m, "DATA/transport/ma_busHeadways.png",
#           height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_busHeadways.png")
```

The average population-weighted headway for all bus routes in the state is `r round(ma_busHeadwayPops_df %>% filter(Group == "Total Pop") %>% select(AvgWHeadway) %>% pull(),1)` minutes. However headways, or service frequencies, vary significantly across population groups. Figure \@ref(fig:loliBusHeadway) below compares the population-weighted average bus headways for different groups across the state. Most groups have average headways lower than the general population. However, persons over age 64 have headways that exceed that of the general population (`r round(ma_busHeadwayPops_df %>% filter(Group == "Over 64") %>% select(AvgWHeadway) %>% pull(),1)` minutes). The shortest population-weighted average headway, experienced by limited English speaking households, as defined by Massachusetts environmental justice policy, is `r round(ma_busHeadwayPops_df %>% arrange(AvgWHeadway) %>% slice(.,1) %>% select(AvgWHeadway) %>% pull(),0)` minutes.
...
Rapid transit routes, which are localized to Boston and adjacent municipalities, show considerably lower average headways than bus routes. Figure \@ref(fig:mapGTFSrapidTransit) shows average headways by line, and Table \@ref(tab:tabGTFSrapidTransit) shows a breakdown of headway times by route. The average population-weighted headway for all rapid transit routes in the state is `r round(ma_RTHeadwayPops_df %>% filter(Group == "Total Pop") %>% select(AvgWHeadway) %>% pull(),1)` minutes. However headways, or service frequencies, vary significantly across population groups. Figure \@ref(fig:loliRTHeadway) below compares the population-weighted average rapid transit headways for different groups within reasonable walking distance of stops. More than half of the groups have average headways higher than the general population. Adults without a high school diploma have the highest population-weighted average headways (`r round(ma_RTHeadwayPops_df %>% filter(Group == "No HS Dip") %>% select(AvgWHeadway) %>% pull(),1)` minutes). The shortest population-weighted average headway, experienced by limited English speaking households, as defined by Massachusetts environmental justice policy, is `r round(ma_RTHeadwayPops_df %>% arrange(AvgWHeadway) %>% slice(.,1) %>% select(AvgWHeadway) %>% pull(),1)` minutes.
...
#             legend.outside.position = c("right", "top"))
# 
# tmap_save(m, "DATA/transport/ma_rtHeadways.png",
#           height = 6, width = 5, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_rtHeadways.png")
```
...
ma_RTHeadwayPops_df %>% 
  ...
  geom_text(aes(x = "Under 18", y = 11, label = "Above state\naverage"),
            color = "gray48") +
  geom_text(aes(x = "Under 18", y = 7.5, label = "Below state\naverage"),
            color = "gray48") +
  expand_limits(y = c(6,13))
```

Headways for commuter rail routes are slightly lower on average than bus routes. Figure \@ref(fig:mapGTFScommuterRail) shows average headways by line, and Table \@ref(tab:tabGTFSrapidCommuterRail) shows a breakdown of headway times by route. The average population-weighted headway for all commuter rail routes in the state is `r round(ma_CRHeadwayPops_df %>% filter(Group == "Total Pop") %>% select(AvgWHeadway) %>% pull(),1)` minutes. However headways, or service frequencies, vary significantly across population groups. Figure \@ref(fig:loliCRHeadway) below compares the population-weighted average commuter rail headways for different groups within 3 miles (4800m) of stops. Most groups have average headways lower than the general population. However, persons over 64 have population-weighted average headways greater than the general population (`r round(ma_CRHeadwayPops_df %>% filter(Group == "Over 64") %>% select(AvgWHeadway) %>% pull(),1)` minutes). The shortest population-weighted average headway, experienced by limited English speaking households, as defined by Massachusetts environmental justice policy, is `r round(ma_CRHeadwayPops_df %>% arrange(AvgWHeadway) %>% slice(.,1) %>% select(AvgWHeadway) %>% pull(),1)` minutes.
...
#             legend.outside.position = c("right", "top"))
# 
# tmap_save(m, "DATA/transport/ma_crHeadways.png",
#           height = 6, width = 5, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_crHeadways.png")
```
...
headway80_commuterRail <- headway80thblkgrps_CR %>%
  ...
  arrange(desc(`Over 64`))
```
The population-weighted average headways above provide a glimpse of average headways across the state for different population groups and for different transit modes. However, headways also vary for specific communities. Indeed, it is important to consider populations of concern or transportation-limited populations that experience excessively large headways or low service frequency. Figures \@ref(fig:mapHeadwayOver64bus) to \@ref(fig:mapHeadwayOver64commuterRail) below highlight communities of persons over 64 and adults without a high school diploma who are within reasonable distance of bus stops (i.e., 400m or 1/4 mile), rapid transit stops (i.e., 800m or 1/2 mile), and commuter rail stops (i.e., 4800m or 3 miles), but where the mean headway for these stops exceeds the 80th percentile of mean route headways for the state. Tables \@ref(tab:tabHeadwayOver64bus) to \@ref(tab:tabHeadwayOver64commuterRail) show breakdowns by municipality. For example, Table \@ref(tab:tabHeadwayOver64bus) shows that `r formatC(as.numeric(headway80thblkgrps_bus[1,3]),big.mark=",")` people over 64 across `r headway80thblkgrps_bus[1,2]` Block Groups in `r headway80thblkgrps_bus[1,1]` resided in areas where the average headway of accessible transit stops exceeded `r quantile(ma_routes_sf_Bus$mean_headways,0.8)` minutes. These people represented `r headway80thblkgrps_bus[1,4]` of people over 64 in `r headway80thblkgrps_bus[1,1]`. Similarly, Table \@ref(tab:tabHeadwayDisabledRT) shows that `r formatC(as.numeric(headway80thblkgrps_RT[1,3]),big.mark=",")` people with disabilities across `r headway80thblkgrps_RT[1,2]` Census Tracts in `r headway80thblkgrps_RT[1,1]` resided in areas where the average headway of accessible transit stops exceeded `r quantile(ma_routes_sf_RT$mean_headways,0.8)` minutes. These people represented `r headway80thblkgrps_RT[1,4]` of people with disabilities in `r headway80thblkgrps_RT[1,1]`.
...
tmap_save(m, "DATA/transport/ma_headwayOver64bus.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayOver64bus.png")
```
...
headway80thblkgrps_bus %>%
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = paste("Persons Over 64","with Average Headways",paste0("Over ",quantile(ma_routes_sf_Bus$mean_headways,0.8)," Minutes"),sep = "\n"), align = "r", col.names = c(names(.)[1:2],"Number of Over 64 in Block Groups","Pct of Over 64 in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
...
m <- tm_shape(ma_towns_sf, bbox = ma_routes_sf_RT, unit = "mi") + 
  ...
  tm_layout(title = paste("Adults without a High","School Diploma","with Headways",paste0("Over ",quantile(ma_routes_sf_RT$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))

tmap_save(m, "DATA/transport/ma_headwayNoHSDipRT.png",
          height = 6, width = 5, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayNoHSDipRT.png")
```
...
headway80thblkgrps_RT %>%
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = paste("Adults without a High School Diploma","with Headways",paste0("Over ",quantile(ma_routes_sf_RT$mean_headways,0.8)," Minutes"),sep = "\n"), align = "r", col.names = c(names(.)[1:2],"Number of No HS Dip in Block Groups","Pct of No HS Dip in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
...
tmap_save(m, "DATA/transport/ma_headwayOver64cr.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayOver64cr.png")
```
...
Figure \@ref(fig:mapWalkability) shows walkability scores by Census Block Group across Massachusetts.  Walkability varies across the state. It is highest in and around the state's major urban centers, such as Providence, Portsmouth, and Newport, and lowest in the western suburbs.
...
tmap_save(m, "DATA/transport/ma_walk.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_walk.png")
```

Walkability varies for different population groups across the state. Figure \@ref(fig:loliWalkability) below compares population-weighted average walkability index scores for different populations. Most groups live in communities with above average walkability index scores that are also at or above that of the general population. However, persons over age 64 and under 18 tend to live in communities with walkability scores below the state average. 
...
tmap_save(m, "DATA/transport/ma_walkO64.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_walkO64.png")
```
...
tmap_save(m, "DATA/transport/ma_walkU18.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_walkU18.png")
```
...
Figure \@ref(fig:mapLAI) below shows transportation cost burden (i.e., transportation cost as a percentage of household income) by Census Tract across Massachusetts. Transportation cost burden varies across the state. It is lowest in and around the state's major urban centers, such as Providence, Pawtucket, Woonsocket, and Newport, and highest in most of the rest of the state. In Little Compton, transportation as a percentage of income exceeds housing. 

```{r mapLAI, fig.align = "center", fig.cap="Transpotation cost burden for Census Tracts across Massachusetts."}
...
tmap_save(m, "DATA/transport/ma_tburden.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_tburden.png")
````
...
```{r loliLAI, fig.align = "center", fig.cap="Population-weighted average transportation cost burden for groups across Massachusetts."}
...
tmap_save(m, "DATA/transport/ma_HiBurdenO64.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_HiBurdenO64.png")
```
...
tmap_save(m, "DATA/transport/ma_HiBurdenU18.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_HiBurdenU18.png")
```
...
tmap_save(m, "DATA/transport/ma_busU18access.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_busU18access.png")
```
...
tmap_save(m, "DATA/transport/ma_busDisabledaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_busDisabledaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_busU5access.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_busU5access.png")
```
...
tmap_save(m, "DATA/transport/ma_busMAINCaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_busMAINCaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_busINCaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_busINCaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_busNOHSaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_busNOHSaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_busMINaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_busMINaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_busNoCaraccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_busNoCaraccess.png")
```
...
tmap_save(m, "DATA/transport/ma_busMAMINaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_busMAMINaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_busLEHaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_busLEHaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_busMALEHaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_busMALEHaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_RTDisabledaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_RTDisabledaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_RTU5access.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_RTU5access.png")
```
...
tmap_save(m, "DATA/transport/ma_RTMAINCaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_RTMAINCaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_RTINCaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_RTINCaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_RTNOHSaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_RTNOHSaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_RTMINaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_RTMINaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_RTNoCaraccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_RTNoCaraccess.png")
```
...
tmap_save(m, "DATA/transport/ma_RTMAMINaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_RTMAMINaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_RTLEHaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_RTLEHaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_RTMALEHaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_RTMALEHaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_CRPRU18access.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_CRPRU18access.png")
```
...
tmap_save(m, "DATA/transport/ma_CRPRDisabledaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_CRPRDisabledaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_CRPRU5access.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_CRPRU5access.png")
```
...
tmap_save(m, "DATA/transport/ma_CRPRMAINCaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_CRPRMAINCaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_CRPRINCaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_CRPRINCaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_CRPRNOHSaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_CRPRNOHSaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_CRPRMINaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_CRPRMINaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_CRPRNoCaraccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_CRPRNoCaraccess.png")
```
...
tmap_save(m, "DATA/transport/ma_CRPRMAMINaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_CRPRMAMINaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_CRPRLEHaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_CRPRLEHaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_CRPRMALEHaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_CRPRMALEHaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_transitU18access.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_transitU18access.png")
```
...
tmap_save(m, "DATA/transport/ma_transitDisabledaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_transitDisabledaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_transitU5access.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_transitU5access.png")
```
...
tmap_save(m, "DATA/transport/ma_transitMAINCaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_transitMAINCaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_transitINCaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_transitINCaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_transitNOHSaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_transitNOHSaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_transitMINaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_transitMINaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_transitNoCaraccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_transitNoCaraccess.png")
```
...
tmap_save(m, "DATA/transport/ma_transitMAMINaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_transitMAMINaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_transitLEHaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_transitLEHaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_transitMALEHaccess.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_transitMALEHaccess.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayDisabledBus.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayDisabledBus.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayUnder5bus.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayUnder5bus.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayUnder18bus.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayUnder18bus.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayMAINCbus.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayMAINCbus.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayINCbus.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayINCbus.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayLTHSbus.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayLTHSbus.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayMINbus.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayMINbus.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayNoCarHHbus.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayNoCarHHbus.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayMAMINbus.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayMAMINbus.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayLEHbus.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayLEHbus.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayMALEHbus.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayMALEHbus.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayDisabledRT.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayDisabledRT.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayUnder5RT.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayUnder5RT.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayUnder18RT.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayUnder18RT.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayMAINCRT.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayMAINCRT.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayINCRT.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayINCRT.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayO64RT.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayO64RT.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayMINRT.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayMINRT.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayNoCarHHRT.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayNoCarHHRT.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayMAMINRT.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayMAMINRT.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayLEHRT.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayLEHRT.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayMALEHRT.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayMALEHRT.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayDisabledCR.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayDisabledCR.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayUnder5CR.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayUnder5CR.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayUnder18CR.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayUnder18CR.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayMAINCCR.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayMAINCCR.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayINCCR.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayINCCR.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayLTHSCR.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayLTHSCR.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayMINCR.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayMINCR.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayNoCarHHCR.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayNoCarHHCR.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayMAMINCR.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayMAMINCR.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayLEHCR.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayLEHCR.png")
```
...
tmap_save(m, "DATA/transport/ma_headwayMALEHCR.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_headwayMALEHCR.png")
```
...
tmap_save(m, "DATA/transport/ma_walkDisabled.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_walkDisabled.png")
```
...
tmap_save(m, "DATA/transport/ma_walkU5.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_walkU5.png")
```
...
tmap_save(m, "DATA/transport/ma_walkNoHSDip.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_walkNoHSDip.png")
```
...
tmap_save(m, "DATA/transport/ma_walkLowInc.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_walkLowInc.png")
```
...
tmap_save(m, "DATA/transport/ma_walkNoCar.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_walkNoCar.png")
```
...
tmap_save(m, "DATA/transport/ma_walkMinority.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_walkMinority.png")
```
...
tmap_save(m, "DATA/transport/ma_walkLEH.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_walkLEH.png")
```
...
tmap_save(m, "DATA/transport/ma_walkMALEH.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_walkMALEH.png")
```
...
tmap_save(m, "DATA/transport/ma_walkMAMIN.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_walkMAMIN.png")
```
...
tmap_save(m, "DATA/transport/ma_walkMAINC.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_walkMAINC.png")
```
...
tmap_save(m, "DATA/transport/ma_HiBurdenDisabled.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_HiBurdenDisabled.png")
```
...
tmap_save(m, "DATA/transport/ma_HiBurdenU5.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_HiBurdenU5.png")
```
...
tmap_save(m, "DATA/transport/ma_HiBurdenLTHS.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_HiBurdenLTHS.png")
```
...
tmap_save(m, "DATA/transport/ma_HiBurdenINC.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_HiBurdenINC.png")
```
...
tmap_save(m, "DATA/transport/ma_HiBurdenNoCarHH.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_HiBurdenNoCarHH.png")
```
...
tmap_save(m, "DATA/transport/ma_HiBurdenMIN.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_HiBurdenMIN.png")
```
...
tmap_save(m, "DATA/transport/ma_HiBurdenLEH.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_HiBurdenLEH.png")
```
...
tmap_save(m, "DATA/transport/ma_HiBurdenMAINC.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_HiBurdenMAINC.png")
```
...
tmap_save(m, "DATA/transport/ma_HiBurdenMAMIN.png",
          height = 4, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ma_HiBurdenMAMIN.png")
```
