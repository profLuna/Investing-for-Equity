...
save(ma_blkgrps_sf_noTransit, ma_tracts_sf_noTransit, ma_blkgrps_sf_noBus, 
     ma_transitAccessPops_df, ma_busBuff400m_sf, file = "DATA/transport/MA/noTransit.Rds")
```
...
ggsave("images/MA_Bus_graph.png")
```
...
ggsave("images/MA_Transit_graph.png")
```
...
ggsave("images/MA_CRHdwy_graph.png")
```
...
m <- tm_shape(ma_state_sf_cb, unit = "mi") +
  ...
  tm_layout(title = paste("Persons Over 64","with Bus","Headways Over",paste0(quantile(ma_routes_sf_Bus$mean_headways,0.8)," Minutes"),sep = "\n"),
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))
...
# save(ma_wAvgWalkability_df,
#      ma_blkgrp_walkability_sf,
...
ggsave("images/MA_Walk_graph.png")
```
...
m <- tm_shape(ma_state_sf_cb, unit = "mi") + 
 ...
 tm_shape(ma_highways) + tm_lines(col = "seashell4", lwd = 1) +
  ...
  tm_layout(title = "Persons Under 18\nin Least Walkable\nBlock Groups", 
            ...
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"),
            inner.margins = c(0.02,0,0.02,0.05))
...
ggsave("images/MA_Cost_graph.png")
```
...
```{r mapBusAccessMIN, fig.align = "center", fig.cap="People of Color who are one or more miles from the nearest bus stop by Census Block Group."}
m <- tm_shape(ma_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(ma_blkgrps_sf_noBus_simple, unit = "mi") +
...
ma_blkgrps_sf_noBus %>%
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "People of Color One or More Miles from Nearest Bus Stop", align = "r", col.names = c(names(.)[1:2],"Number of POC in Block Groups","Pct of POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
...
```{r mapBusAccessMAMIN, fig.align = "center", fig.cap="People of Color, as defined by state environmental justice policy, who are one or more miles from the nearest bus stop by Census Block Group."}
m <- tm_shape(ma_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(ma_blkgrps_sf_noBus_simple, unit = "mi") +
  ...
  tm_scale_bar(breaks = c(0, 10, 20), text.size = 0.5, 
               position = c(0.6,0.005)) +
  # tm_add_legend(type = "line", lwd=2, alpha = 0.5, labels = "Transit Route") +
  tm_layout(title = "MA People of Color\n1+ Miles from\nNearest Bus\nStop", 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))
...
```{r tabBusAccessMAMIN, fig.align = "center", fig.cap="MA People of Color in Census Block Groups one or more miles from the nearest bus stop."}
ma_blkgrps_sf_noBus %>%
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "MA People of Color One or More Miles from Nearest Bus Stop", align = "r", col.names = c(names(.)[1:2],"Number of MA POC in Block Groups","Pct of MA POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
...
### No Rapid Transit Access and Priority Populations {-}
...
```{r mapRTAccessMIN, fig.align = "center", fig.cap="People of Color who are one or more miles from the nearest rapid transit stop by Census Block Group."}
m <- tm_shape(ma_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(ma_blkgrps_sf_noRT_simple, unit = "mi") +
  tm_fill(col = "NewMinority", style = "equal",
...
```{r tabRTAccessMIN, fig.align = "center", fig.cap="People of Color in Census Block Groups one or more miles from the nearest rapid transit stop."}
ma_blkgrps_sf_noRT %>%
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "People of Color One or More Miles from Nearest Rapid Transit Stop", align = "r", col.names = c(names(.)[1:2],"Number of POC in Block Groups","Pct of POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
...
```{r mapRTAccessMAMIN, fig.align = "center", fig.cap="People of Color, as defined by state environmental justice policy, who are one or more miles from the nearest rapid transit stop by Census Block Group."}
m <- tm_shape(ma_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(ma_blkgrps_sf_noRT_simple, unit = "mi") +
  tm_fill(col = "NewMA_MINORITY", style = "equal",
...
```{r tabRTAccessMAMIN, fig.align = "center", fig.cap="MA People of Color in Census Block Groups one or more miles from the nearest rapid transit stop."}
ma_blkgrps_sf_noRT %>%
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "MA People of Color One or More Miles from Nearest Rapid Transit Stop", align = "r", col.names = c(names(.)[1:2],"Number of POC in Block Groups","Pct of POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
...
```{r mapCRPRAccessMIN, fig.align = "center", fig.cap="People of Color who are ten or more miles from the nearest commuter rail stop or park-in-ride lot by Census Block Group."}
m <- tm_shape(ma_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(ma_blkgrps_sf_noCRPR_simple, unit = "mi") +
  tm_fill(col = "NewMinority", style = "equal",
...
```{r tabCRPRAccessMIN, fig.align = "center", fig.cap="People of Color in Census Block Groups ten or more miles from the nearest commuter rail stop or park-in-ride lot."}
ma_blkgrps_sf_noCRPR %>%
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "People of Color Ten or More Miles from Nearest Commuter Rail Stop or Park-in-Ride Lot", align = "r", col.names = c(names(.)[1:2],"Number of POC in Block Groups","Pct of POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
...
```{r mapCRPRAccessMAMIN, fig.align = "center", fig.cap="People of Color, as defined by state environmental justice policy, who are ten or more miles from the nearest commuter rail stop or park-in-ride lot by Census Block Group."}
m <- tm_shape(ma_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(ma_blkgrps_sf_noCRPR_simple, unit = "mi") +
  tm_fill(col = "NewMA_MINORITY", style = "equal",
...
```{r tabCRPRAccessMAMIN, fig.align = "center", fig.cap="MA People of Color in Census Block Groups ten or more miles from the nearest commuter rail stop or park-in-ride lot."}
ma_blkgrps_sf_noCRPR %>%
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "MA People of Color Ten or More Miles from Nearest Commuter Rail Stop or Park-in-Ride Lot", align = "r", col.names = c(names(.)[1:2],"Number of POC in Block Groups","Pct of POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
...
ma_blkgrps_sf_noTransit %>%
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "People of Color without Reasonable Access to any Mode of Transit", align = "r", col.names = c(names(.)[1:2],"Number of POC in Block Groups","Pct of POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
...
```{r mapTransitAccessMAMIN, fig.align = "center", fig.cap="People of Color, as defined by state environmental justice policy, without reasonable access to any form of transit by Census Block Group.", include=FALSE, eval=FALSE}
m <- tm_shape(ma_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(ma_blkgrps_sf_noTransit_simple, unit = "mi") +
  tm_fill(col = "NewMA_MINORITY", style = "equal",
...
```{r tabTransitAccessMAMIN, fig.align = "center", fig.cap="MA People of Color in Census Block Groups without reasonable access to any form of transit.", include=FALSE, eval=FALSE}
ma_blkgrps_sf_noTransit %>%
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "MA People of Color without Reasonable Access to any Mode of Transit", align = "r", col.names = c(names(.)[1:2],"Number of POC in Block Groups","Pct of POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
...
ma_blkgrps_sf_noTransit %>%
  ...
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
No groups meeting environmental justice criteria for People of Color or limited English speaking households were found in areas without reasonable access to some form of transit. 
...
```{r mapHeadwayBusMIN, fig.align = "center", fig.cap="People of Color within 400m or 1/4 mile of bus stops in which the mean headway for these stops is above the 80th percentile for the state."}
m <- tm_shape(ma_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(headway80thblkgrps_bus, unit = "mi") +
  tm_fill(col = "NewMinority", style = "equal",
  ...
  tm_scale_bar(breaks = c(0, 10, 20), text.size = 0.5, 
               position = c(0.6,0.005)) +
  # tm_add_legend(type = "line", lwd=2, alpha = 0.5, labels = "Transit Route") +
  tm_layout(title = paste("People of Color","with Bus Headways",paste0("Over ",quantile(ma_routes_sf_Bus$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))
...
```{r tabHeadwayMIN, fig.align = "center", fig.cap="People of Color within 400m or 1/4 mile of transit stops in which the mean headway for these stops is above the 80th percentile for the state."}
headway80thblkgrps_bus %>%
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = paste("People of Color","with Bus Headways",paste0("Over ",quantile(ma_routes_sf_Bus$mean_headways,0.8)," Minutes"),sep = "\n"), align = "r", col.names = c(names(.)[1:2],"Number of POC in Block Groups","Pct of POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
...
```{r mapHeadwayBusMAMIN, fig.align = "center", fig.cap="People of Color, as defined by state environmental justice policy, within 400m or 1/4 mile of bus stops in which the mean headway for these stops is above the 80th percentile for the state."}
m <- tm_shape(ma_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(headway80thblkgrps_bus, unit = "mi") +
  tm_fill(col = "NewMA_MINORITY", style = "equal",
  ...
  tm_scale_bar(breaks = c(0, 10, 20), text.size = 0.5, 
               position = c(0.6,0.005)) +
  # tm_add_legend(type = "line", lwd=2, alpha = 0.5, labels = "Transit Route") +
  tm_layout(title = paste("MA People of Color","with Bus Headways", paste0("Over ",quantile(ma_routes_sf_Bus$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))
...
```{r tabHeadwayMAMIN, fig.align = "center", fig.cap="MA People of Color within 400m or 1/4 mile of transit stops in which the mean headway for these stops is above the 80th percentile for the state."}
headway80thblkgrps_bus %>%
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = paste("MA People of Color","with Bus Headways", paste0("Over ",quantile(ma_routes_sf_Bus$mean_headways,0.8)," Minutes"),sep = "\n"), align = "r", col.names = c(names(.)[1:2],"Number of POC in Block Groups","Pct of POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
...
### Excessive Rapid Transit Headways and Priority Populations {-}
...
```{r tabHeadwayRTMAINC, fig.align = "center", fig.cap="Low income persons, as defined by state environmental justice policy, within 800m or 1/2 mile of rapid transit stops in which the mean headway for these stops is above the 80th percentile for the state.", eval=FALSE}
headway80thblkgrps_RT %>%
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
...
```{r mapHeadwayRTMIN, fig.align = "center", fig.cap="People of Color within 800m or 1/2 mile of rapid transit stops in which the mean headway for these stops is above the 80th percentile for the state."}
m <- tm_shape(ma_towns_sf, bbox = ma_routes_sf_RT, unit = "mi") + 
  tm_polygons(col = "gray", border.alpha = 0.8, lwd = 0.2, alpha = 0.2) +
  tm_text("NAME", size = 0.7, remove.overlap = TRUE, col = "gray") +
  tm_shape(ma_highways) + tm_lines(col = "seashell4", lwd = 1) +
  ...
  tm_scale_bar(breaks = c(0, 1, 2), text.size = 0.5, 
               position = c(0.6,0.005)) +
  # tm_add_legend(type = "line", lwd=2, alpha = 0.5, labels = "Transit Route") +
  tm_layout(title = paste("People of Color","with Rapid Transit Headways",paste0("Over ",quantile(ma_routes_sf_RT$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))
...
```{r tabHeadwayRTMIN, fig.align = "center", fig.cap="People of Color within 800m or 1/2 mile of rapid transit stops in which the mean headway for these stops is above the 80th percentile for the state."}
headway80thblkgrps_RT %>%
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = paste("People of Color","with Rapid Transit Headways",paste0("Over ",quantile(ma_routes_sf_RT$mean_headways,0.8)," Minutes"),sep = "\n"), align = "r", col.names = c(names(.)[1:2],"Number of POC in Block Groups","Pct of POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
...
```{r mapHeadwayRTMAMIN, fig.align = "center", fig.cap="People of Color, as defined by state environmental justice policy, within 800m or 1/2 mile of rapid transit stops in which the mean headway for these stops is above the 80th percentile for the state."}
m <- tm_shape(ma_towns_sf, bbox = ma_routes_sf_RT, unit = "mi") + 
  tm_polygons(col = "gray", border.alpha = 0.8, lwd = 0.2, alpha = 0.2) +
  tm_text("NAME", size = 0.7, remove.overlap = TRUE, col = "gray") +
  tm_shape(ma_highways) + tm_lines(col = "seashell4", lwd = 1) +
  ...
  tm_scale_bar(breaks = c(0, 1, 2), text.size = 0.5, 
               position = c(0.6,0.005)) +
  # tm_add_legend(type = "line", lwd=2, alpha = 0.5, labels = "Transit Route") +
  tm_layout(title = paste("MA People of Color","with Rapid Transit Headways", paste0("Over ",quantile(ma_routes_sf_RT$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))
...
```{r tabHeadwayRTMAMIN, fig.align = "center", fig.cap="MA People of Color within 800m or 1/2 mile of rapid transit stops in which the mean headway for these stops is above the 80th percentile for the state."}
headway80thblkgrps_RT %>%
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = paste("MA People of Color","with Rapid Transit Headways", paste0("Over ",quantile(ma_routes_sf_RT$mean_headways,0.8)," Minutes"),sep = "\n"), align = "r", col.names = c(names(.)[1:2],"Number of POC in Block Groups","Pct of POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
...
```{r mapHeadwayCRMIN, fig.align = "center", fig.cap="People of Color within 4800m or 3 miles of commuter rail stops in which the mean headway for these stops is above the 80th percentile for the state."}
m <- tm_shape(ma_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(headway80thblkgrps_CR, unit = "mi") +
  tm_fill(col = "NewMinority", style = "equal",
  ...
  tm_scale_bar(breaks = c(0, 10, 20), text.size = 0.5, 
               position = c(0.6,0.005)) +
  # tm_add_legend(type = "line", lwd=2, alpha = 0.5, labels = "Transit Route") +
  tm_layout(title = paste("People of Color","with Commuter", "Rail Headways",paste0("Over ",quantile(ma_routes_sf_Bus$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))
...
```{r tabHeadwayCRMIN, fig.align = "center", fig.cap="People of Color within 4800m or 3 miles of transit stops in which the mean headway for these stops is above the 80th percentile for the state."}
headway80thblkgrps_CR %>%
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = paste("People of Color","with Commuter", "Rail Headways",paste0("Over ",quantile(ma_routes_sf_Bus$mean_headways,0.8)," Minutes"),sep = "\n"), align = "r", col.names = c(names(.)[1:2],"Number of POC in Block Groups","Pct of POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
...
```{r mapHeadwayCRMAMIN, fig.align = "center", fig.cap="People of Color, as defined by state environmental justice policy, within 4800m or 3 miles of commuter rail stops in which the mean headway for these stops is above the 80th percentile for the state."}
m <- tm_shape(ma_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(headway80thblkgrps_CR, unit = "mi") +
  tm_fill(col = "NewMA_MINORITY", style = "equal",
  ...
  tm_scale_bar(breaks = c(0, 10, 20), text.size = 0.5, 
               position = c(0.6,0.005)) +
  # tm_add_legend(type = "line", lwd=2, alpha = 0.5, labels = "Transit Route") +
  tm_layout(title = paste("MA People of Color","with Commuter", "Rail Headways", paste0("Over ",quantile(ma_routes_sf_Bus$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))
...
```{r tabHeadwayCRMAMIN, fig.align = "center", fig.cap="MA People of Color within 4800m or 3 miles of transit stops in which the mean headway for these stops is above the 80th percentile for the state."}
headway80thblkgrps_CR %>%
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = paste("MA People of Color","with Commuter", "Rail Headways", paste0("Over ",quantile(ma_routes_sf_Bus$mean_headways,0.8)," Minutes"),sep = "\n"), align = "r", col.names = c(names(.)[1:2],"Number of POC in Block Groups","Pct of POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
...
```{r mapLowWalkMAMIN, fig.align = "center", fig.cap="People of Color, as defined by state environmental justice policy, per square kilometer in least walkable Census Block Groups (i.e., Walkability Index Score less than or equal to 5.8)."}
m <- tm_shape(ma_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(leastWalkable, unit = "mi") +
  tm_fill(col = "MA_MINORITY", alpha = 0.9, style = "equal",
          colorNA = "white", colorNULL = "gray", title = "MA POC\nPer Square Kilometer",
          legend.format = list(fun = function(x) formatC(x, digits = 0, format = "f")), palette = "OrRd", convert2density = TRUE, area = "SqKm") +
  tm_shape(ma_tracts_sf) + tm_borders(alpha = 0.5, lwd = 0.2) +
  tm_shape(ne_states_sf_cb) + tm_borders(lwd = 0.2, alpha = 0.8) + 
  tm_text("STUSPS", size = 0.7, remove.overlap = TRUE, col = "gray") +
...
```{r tabLowWalkMAMIN, fig.align = "center", fig.cap="People of Color, as defined by state environmental justice policy, by municipality in least walkable Census Block Groups (i.e., Walkability Index Score less than or equal to 5.8)."}
leastWalkable %>%
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "MA People of Color in Least Walkable Block Groups", align = "r", col.names = c(names(.)[1:2],"Number of MA POC in Block Groups","Pct of MA POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
```
...
```{r mapHiBurdenMAMIN, fig.align = "center", fig.cap="People of Color, as defined by state environmental justice policy, per square kilometer in Census Block Groups with the highest transportation cost burden (i.e., transportation cost burden in the 80th percentile for the state)."}
m <- tm_shape(ma_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(HiBurden, unit = "mi") +
  tm_fill(col = "MA_MINORITY", alpha = 0.9, style = "equal",
...
```{r tabHiBurdenMAMIN, fig.align = "center", fig.cap="People of Color, as defined by state environmental justice policy, by municipality in Census Block Groups with the highest transportation cost burden (i.e., transportation cost burden in the 80th percentile for the state)."}
HiBurden %>%
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "MA People of Color in Highest Transportation Cost Burden Block Groups", align = "r", col.names = c(names(.)[1:2],"Number of MA POC in Block Groups","Pct of MA POC in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
```
