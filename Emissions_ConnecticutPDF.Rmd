---
title: "Transportation Emissions in Connecticut"
...
ct_blkgrp_sf %>% 
  ...
  geom_text(aes(x = "Under 5", y = 1.7, label = "Above state avg"),
            color = "gray48") +
...
ct_blkgrp_sf %>% 
  ...
  geom_text(aes(x = Group, y = Pct + 0.2 * sign(Pct), 
            ...
            hjust = 1.15, vjust = -.8, size = 3,
            color=rgb(100,100,100, maxColorValue=255)) +
  scale_y_continuous(labels = function(x) paste0(x, "%")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  geom_text(aes(x = "No HS Dip", y = .5, label = "Above state avg"),
            color = "gray48") +
  geom_segment(aes(x = "Low Income", xend = "Low Income", y = 0.2, yend = 0.6), 
               arrow = arrow(length = unit(0.3,"cm"))) +
...
There is a moderate to strong positive correlation between the proportions of language isolated households and minorities and ambient concentrations of Diesel Particulate Matter (see Appendix).
...
ct_blkgrp_sf %>% 
  ...
  scale_y_continuous(labels = function(x) paste0(x, "%")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  geom_text(aes(x = "Low Income", y = 3, label = "Above state avg"),
            color = "gray48") +
...
There is a moderately positive correlation between the proportions of minorities and limited English households and cancer risk (see Appendix).
...
There is a moderate positive correlation between the proportions of minorities, low income persons, limited English households, adults with less than a high school education, and traffic proximity and volume (see Appendix).
