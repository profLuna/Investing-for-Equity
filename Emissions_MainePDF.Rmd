...
In addition to variations in the general geography of PM~2.5~ concentrations, exposure to these pollutants also varies demographically. Figure \@ref(fig:barplotPM25PopAvg) below shows population-weighted exposures for populations of concern relative to average PM~2.5~ concentrations for the state. For example, limited English speaking households are exposed to PM~2.5~ concentrations that are over 1.8% above concentrations for the state as a whole. By contrast, adults without a high school diploma are exposed to concentrations below the state average. 
...
ggsave("images/ME_DPM_graph.png")
```

There is a weak positive correlation between the proportions of People of Color and ambient concentrations of DPM (see Figure \@ref(fig:cormatrixDPMPopAvg) in Appendix B).
...
In addition to variations in the general geography of cancer risk, exposure to these risks also varies demographically. Figure \@ref(fig:barplotATCPopAvgRI) below shows population-weighted exposures for populations of concern relative to average cancer risk for the state. For example, limited English speaking households in Maine experience cancer risks from inhalation of air toxics that are more than 6% above the state as a whole. Similarly, People of Color experience  cancer risks more than 5% above the state average. In fact, all populations concern are exposed to concentrations above the state average. 
...
# savegraph to image
ggsave("images/ME_Cancer_graph.png")
```

There is a weak positive correlation between the proportions of People of Color and cancer risk (see Figure \@ref(fig:cormatrixATCPopAvg) in Appendix B).
...
In addition to variations in the general geography of the respiratory hazard index, exposure to these risks also varies demographically. Figure \@ref(fig:barplotRHIPopAvg) below shows population-weighted exposures for populations of concern relative to average respiratory hazard index for the state. For example, limited English speaking households in Maine experience respiratory hazard indices that are over 10% above the state as a whole. Similarly, People of Color experience hazard index values more than 7% above the state average. By contrast, persons over age 64 are exposed to an average hazard index below the state average. 
...
#save graph to image
ggsave("images/ME_Resp_graph.png")
```

There is a weak positive correlation between the proportions of People of Color and respiratory hazard index (see Figure \@ref(fig:cormatrixRHIPopAvg) in Appendix B).
...
In addition to variations in the general geography of the traffic proximity and volume exposure, this exposure also varies demographically. Figure \@ref(fig:barplotTPVPopAvgNE) below shows population-weighted exposures for populations of concern relative to average traffic proximity and volume for the state. For example, People of Color are exposed to traffic proximity and volume more than 180% above the state average. By contrast, persons over age 64 are, on average, are exposed to traffic proximity and volume of more than 17% below the state average. 
...
# save graph to image
ggsave("images/ME_Traffic_graph.png")
```
...
The total or sum of the products (i.e., POC x PM~2.5~ concentrations) is then divided by the sum of the weights (i.e., total POC), so that 324.5/45 = `r round(324.5/45,2)`. The result is a weighted average PM~2.5~ concentration that is influenced by the number of People of Color. 
