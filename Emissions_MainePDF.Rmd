...
me_blkgrp_sf %>% 
  ...
  ggtitle(expression(paste("Total Maine On-road ", CO[2], " Emissions by Year, 1990 - 2017", sep = ""))) +
  theme_minimal()
```
...
me_blkgrp_sf %>% 
  ...
  scale_y_continuous(labels = function(x) paste0(x, "%")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  geom_text(aes(x = "No HS Diploma", y = 2, label = "Above state\naverage"),
            color = "gray48") +
...
me_blkgrp_sf %>% 
  ...
  geom_text(aes(x = "Low Income", y = -3, label = "Below state\naverage"),
            color = "gray48") +
  # geom_segment(aes(x = "No HS Diploma", xend = "No HS Diploma", y = 1, yend = 4), 
  #              arrow = arrow(length = unit(0.3,"cm"))) +
...
me_blkgrp_sf %>% 
  ...
  geom_text(aes(x = "No HS Diploma", y = 50, label = "Above state\naverage"),
            color = "gray48") +
  geom_text(aes(x = "No HS Diploma", y = -30, label = "Below state\naverage"),
            color = "gray48") +
