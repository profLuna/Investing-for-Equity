...
### Diesel Particulate Matter in Maine and Priority Populations
...
### Lifetime Cancer Risk from Inhalation of Air Toxics in Maine and Priority Populations

In addition to variations in the general geography of cancer risk, exposure to these risks also varies demographically. Figure \@ref(fig:barplotATCPopAvgRI) below shows population-weighted exposures for priority populations relative to average cancer risk for the state. For example, limited English speaking households in Maine experience cancer risks from inhalation of air toxics that are more than 6% above the state as a whole. Similarly, People of Color experience  cancer risks more than 5% above the state average. In fact, all populations concern are exposed to concentrations above the state average. 
...
### Respiratory Hazard Index from Inhalation of Air Toxics in Maine and Priority Populations

In addition to variations in the general geography of the respiratory hazard index, exposure to these risks also varies demographically. Figure \@ref(fig:barplotRHIPopAvg) below shows population-weighted exposures for priority populations relative to average respiratory hazard index for the state. For example, limited English speaking households in Maine experience respiratory hazard indices that are over 10% above the state as a whole. Similarly, People of Color experience hazard index values more than 7% above the state average. By contrast, persons over age 64 are exposed to an average hazard index below the state average. 
...
### Traffic Proximity and Volume Exposure in Maine and Priority Populations

In addition to variations in the general geography of the traffic proximity and volume exposure, this exposure also varies demographically. Figure \@ref(fig:barplotTPVPopAvgNE) below shows population-weighted exposures for priority populations relative to average traffic proximity and volume for the state. For example, People of Color are exposed to traffic proximity and volume more than 180% above the state average. By contrast, persons over age 64 are, on average, are exposed to traffic proximity and volume of more than 17% below the state average. 
