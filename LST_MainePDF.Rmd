...
ggsave("images/ME_LSTDay_graph.png")
```


```{r tabLSTDayPopAvgME, fig.align = "center", fig.cap="Population-weighted average exposures to Daytime LST for priority populations in Maine relative to the state average."}
LSTDayPopTab %>% 
  arrange(Group) %>% 
  mutate(Group = recode(Group, "Minority" = "People of Color",
                        "No HS Dip" = "No HS Diploma")) %>%
...
ggsave("images/ME_UHIDay_graph.png")
```


```{r tabUHIDayPopAvgME, fig.align = "center", fig.cap="Population-weighted average exposures to daytime Urban Heat Island effect for priority populations in Maine relative to the rural average."}
UHIDayPopTab %>% 
  arrange(Group) %>% 
  mutate(Group = recode(Group, "Minority" = "People of Color",
                        "No HS Dip" = "No HS Diploma")) %>%
...
ggsave("images/ME_LSTNight_graph.png")
```


```{r tabLSTNightPopAvgME, fig.align = "center", fig.cap="Population-weighted average exposures to nighttime LST for priority populations in Maine relative to the state average."}
LSTNightPopTab %>% 
  arrange(Group) %>% 
  mutate(Group = recode(Group, "Minority" = "People of Color",
                        "No HS Dip" = "No HS Diploma")) %>%
...
ggsave("images/ME_UHINight_graph.png")
```


```{r tabUHINightPopAvgME, fig.align = "center", fig.cap="Population-weighted average exposures to nighttime Urban Heat Island effect for priority populations in Maine relative to the rural average."}
UHINightPopTab %>% 
  mutate(Group = recode(Group, "Minority" = "People of Color",
                        "No HS Dip" = "No HS Diploma")) %>%
  arrange(Group) %>% 
...
```{r cormatrixLSTpopsME, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Spearman's correlation matrix of temperature and the proportions of priority populations by Census Block Group."}
