...
vt_blkgrp_sf %>% 
  ...
  scale_y_continuous(labels = function(x) paste0(x, "%")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  geom_text(aes(x = "No HS Diploma", y = 7, label = "Above state\naverage"),
            color = "gray48") +
  geom_text(aes(x = "No HS Diploma", y = -7, label = "Below state\naverage"),
            color = "gray48") +
...
vt_blkgrp_sf %>% 
  ...
  scale_y_continuous(labels = function(x) paste0(x, "%")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  geom_text(aes(x = "No HS Diploma", y = 4, label = "Above state\naverage"),
            color = "gray48") +
  geom_text(aes(x = "No HS Diploma", y = -2.5, label = "Below state\naverage"),
            color = "gray48") +
