...
```{r statsPM, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Annual ozone concentrations at Census Block Group level for the state."}
vt_blkgrp_sf %>% 
  as.data.frame() %>% 
  # group_by(STATE) %>% 
...
Cancer risks are concentrated in the northwest, in and around Burliington and also along the southern stretch of I-91 (see Figure \@ref(fig:mapATCNE) below).
