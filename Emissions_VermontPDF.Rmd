...
In addition to variations in the general geography of PM~2.5~ concentrations, exposure to these pollutants also varies demographically. Figure \@ref(fig:barplotPM25PopAvg) below shows population-weighted exposures for populations of concern relative to average PM~2.5~ concentrations for the state. All populations of concern are are at or below the state average for PM~2.5~ concentrations. 
...
In addition to variations in the general geography of Ozone (O~3~) concentrations, exposure to this pollutant also varies demographically. Figure \@ref(fig:barplotO3PopAvg) below shows population-weighted exposures for populations of concern relative to average Ozone concentrations for the state. For example, limited English households in Vermont are exposed to summer Ozone concentrations that are approximately 0.65% above concentrations for the state as a whole. Similarly, minorities are exposed to concentrations 0.5% above the state average. By contrast, all other populations of concern are, on average, exposed to concentrations of Ozone at or below the state average. 
...
In addition to variations in the general geography of the respitory hazard index, exposure to these risks also varies demographically. Figure \@ref(fig:barplotRHIPopAvg) below shows population-weighted exposures for populations of concern relative to average respiratory hazard index for the state. For example, limited English speaking households in Vermont experience respiratory hazard indices that are over 14% above the state as a whole. Similarly, minorities experience respiratory hazard indices more than 10% above the state average. In fact, all populations of concern are exposed to respiratory hazard indices above the state average. 
