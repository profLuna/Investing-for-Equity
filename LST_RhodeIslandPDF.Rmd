...
LST24MinorityRI5 %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    ...
                    digits = 1,
                    caption = "RI POC in Highest Quintile of Day-Night Avg LST", align = "r",
                    col.names = c(names(.)[1:2], "PRI POC*", "Pct of RI POC", names(.)[5:7])) %>% 
...
The total or sum of the products (i.e., POC x Temperature) is then divided by the sum of the weights (i.e., POC population), so that 3475/45 = `r round(3475/45,2)`. The result is a weighted average temperature that is influenced by the number of People of Color. 
