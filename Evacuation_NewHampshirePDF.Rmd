...
ggsave("DATA/FEMA/NH/nh_flood_lolli.png")
  # geom_segment(aes(x = "Total Pop", xend = "Total Pop", y = 5.9, yend = 6.6), 
  #              arrow = arrow(length = unit(0.3,"cm")))
```

The maps below (Figures \@ref(fig:mapNFHZAPopConcern1) and \@ref(fig:mapNFHZAPopConcern2)) show households without a car and disabled persons who are disproportionately exposed to flood risk. Maps for other populations of concern can be found in Figures \@ref(fig:mapNFHZAPopConcern3) to \@ref(fig:mapNFHZAPopConcern9) and breakdowns by municipality in Tables \@ref(tab:tabNFHZANoCar) to \@ref(tab:tabNFHZAU5) in Appendix B.
...
# 
# Under5_hevac_pts <- pop2points(nh_blkgrps_hevac,NewUnder5,"Under 5")
# 
# Over64_hevac_pts <- pop2points(nh_blkgrps_hevac,NewOver64,"Over 64")
# 
# Under18_hevac_pts <- pop2points(nh_blkgrps_hevac,NewUnder18,"Under 18")
# 
# # Bring them together
...
```{r mapHEVACPopConcern1, fig.align = "center", fig.cap="Persons Over 64 Living within Hurricane Inundation Zones."}
# Create data subset
hevac_sub <- nh_hevac_vulnerable %>% 
...
tmap_save(m2, "DATA/FEMA/NH/NH_hevac_vulnerable1.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/NH/NH_hevac_vulnerable1.png")
```

```{r mapHEVACPopConcern2, fig.align = "center", fig.cap="Households without a Car Living within Hurricane Inundation Zones."}
# Create data subset
hevac_sub <- nh_hevac_vulnerable %>% 
  filter(Group == "No Car HH")
...
tmap_save(m2, "DATA/FEMA/NH/NH_hevac_vulnerable2.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/NH/NH_hevac_vulnerable2.png")
```
...
```{r mapNFHZAPopConcern3, fig.align = "center", fig.cap="Low Income Persons Living within Flood Zones."}
# create pop subset
nfhza_sub <- nh_nfhza_vulnerable %>% 
...
tmap_save(m, "DATA/FEMA/NH/NH_nhfza_vulnerable3.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/NH/NH_nhfza_vulnerable3.png")
```
...
```{r mapNFHZAPopConcern4, fig.align = "center", fig.cap="Adults without a High School Diploma Living within Flood Zones."}
# create pop subset
nfhza_sub <- nh_nfhza_vulnerable %>% 
...
tmap_save(m, "DATA/FEMA/NH/NH_nhfza_vulnerable4.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/NH/NH_nhfza_vulnerable4.png")
```
...
```{r mapNFHZAPopConcern5, fig.align = "center", fig.cap="Persons Over 64 Living within Flood Zones."}
# create pop subset
nfhza_sub <- nh_nfhza_vulnerable %>% 
  filter(Group == "Over 64")
...
tmap_save(m, "DATA/FEMA/NH/NH_nhfza_vulnerable5.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/NH/NH_nhfza_vulnerable5.png")
```
...
```{r mapNFHZAPopConcern6, fig.align = "center", fig.cap="Minority Persons Living within Flood Zones."}
# create pop subset
nfhza_sub <- nh_nfhza_vulnerable %>% 
...
tmap_save(m, "DATA/FEMA/NH/NH_nhfza_vulnerable6.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/NH/NH_nhfza_vulnerable6.png")
```
...
```{r mapNFHZAPopConcern7, fig.align = "center", fig.cap="Limited English Speaking Households Living within Flood Zones."}
# create pop subset
nfhza_sub <- nh_nfhza_vulnerable %>% 
...
tmap_save(m, "DATA/FEMA/NH/NH_nhfza_vulnerable7.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/NH/NH_nhfza_vulnerable7.png")
```
...
```{r mapNFHZAPopConcern8, fig.align = "center", fig.cap="Persons Under 18 Living within Flood Zones."}
# create pop subset
nfhza_sub <- nh_nfhza_vulnerable %>% 
...
tmap_save(m, "DATA/FEMA/NH/NH_nhfza_vulnerable8.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/NH/NH_nhfza_vulnerable8.png")
```
...
```{r mapNFHZAPopConcern9, fig.align = "center", fig.cap="Children Under 5 Living within Flood Zones."}
# create pop subset
nfhza_sub <- nh_nfhza_vulnerable %>% 
...
tmap_save(m, "DATA/FEMA/NH/NH_nhfza_vulnerable9.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/NH/NH_nhfza_vulnerable9.png")
```
...
```{r mapHEVACPopConcern3, fig.align = "center", fig.cap="Disabled Persons Living within Hurricane Inundation Zones."}
# Create data subset
hevac_sub <- nh_hevac_vulnerable %>% 
  filter(Group == "Disabled")
...
tmap_save(m2, "DATA/FEMA/NH/NH_hevac_vulnerable3.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/NH/NH_hevac_vulnerable3.png")
```
...
```{r mapHEVACPopConcern4, fig.align = "center", fig.cap="Low Income Persons Living within Hurricane Inundation Zones."}
# Create data subset
hevac_sub <- nh_hevac_vulnerable %>% 
  filter(Group == "Low Income")
...
tmap_save(m2, "DATA/FEMA/NH/NH_hevac_vulnerable4.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/NH/NH_hevac_vulnerable4.png")
```
...
```{r mapHEVACPopConcern5, fig.align = "center", fig.cap="Persons Under 18 Living within Hurricane Inundation Zones."}
# Create data subset
hevac_sub <- nh_hevac_vulnerable %>% 
  filter(Group == "Under 18")
...
tmap_save(m2, "DATA/FEMA/NH/NH_hevac_vulnerable5.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/NH/NH_hevac_vulnerable5.png")
```
...
```{r mapHEVACPopConcern6, fig.align = "center", fig.cap="Adults without a High School Living within Hurricane Inundation Zones."}
# Create data subset
hevac_sub <- nh_hevac_vulnerable %>% 
  filter(Group == "No HS Dip")
...
tmap_save(m2, "DATA/FEMA/NH/NH_hevac_vulnerable6.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/NH/NH_hevac_vulnerable6.png")
```
...
```{r mapHEVACPopConcern7, fig.align = "center", fig.cap="Minority Persons Living within Hurricane Inundation Zones."}
# Create data subset
hevac_sub <- nh_hevac_vulnerable %>% 
  filter(Group == "Minority")
...
tmap_save(m2, "DATA/FEMA/NH/NH_hevac_vulnerable7.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/FEMA/NH/NH_hevac_vulnerable7.png")
```
