...
```{r mapNFHZAPopConcern6, fig.align = "center", fig.cap="People of Color Living within Flood Zones."}
# create pop subset
nfhza_sub <- nh_nfhza_vulnerable %>% 
...
```{r mapHEVACPopConcern7, fig.align = "center", fig.cap="People of Color Living within Hurricane Inundation Zones."}
# Create data subset
hevac_sub <- nh_hevac_vulnerable %>% 
  filter(Group == "Minority")
