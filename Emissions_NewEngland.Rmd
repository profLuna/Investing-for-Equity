...
```{r slopegraphPM25NE, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Annual PM~2.5~ concentrations for 2011 and 2016 for New England and states."}
...
```{r slopegraphPM25PopAvgNE, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Annual PM~2.5~ concentrations by population of concern for 2011 and 2016."}
...
```{r cormatrixPM25PopAvg, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Spearman's correlation matrix of annual PM~2.5~ concentrations and the proportions of populations of concern by Census Block Group.", include=FALSE}
...
```{r slopegraphO3NE, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Summer average Ozone (O~3~) concentrations for 2011 and 2016 for New England and states."}
...
```{r slopegraphO3PopAvgNE, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Summer Ozone (O~3~) concentrations by population of concern for 2011 and 2016."}
...
```{r cormatrixO3PopAvg, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Spearman's correlation matrix of summer Ozone concentrations and the proportions of populations of concern by Census Block Group.", include=FALSE}
# Create a correlation matrix of PM25 and populations of concern
corrO3 <- ne_blkgrp_sf %>% 
  as.data.frame() %>% 
...
```{r hotspotCO2NE, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Hot spot map of 2017 On-road CO2 Emissions at Census Block Group level."}
# Get rid of empty geometries and NAs, and convert to spdf
empty_geo <- st_is_empty(ne_blkgrp_sf)
ne_blkgrp_sp_DemoEJ <- ne_blkgrp_sf[!empty_geo,] %>% 
  mutate(onroad_2017 = kgco2_2017/1000) %>%
...
CO~2~ emissions vary by state (see Table \@ref(tab:statsCO2NE) above and Figure \@ref(fig:boxplotCO2NE) below). Massachusetts shows the highest absolute on-road emissions.  

```{r statsCO2NE, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Annual 2017 On-road CO~2~ emissions (mtons) at Census Block Group level and by state."}
ne_blkgrp_sf %>% 
  mutate(onroad_2017 = kgco2_2017/1000) %>%
  as.data.frame() %>% 
  group_by(STATE) %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    ...
                    caption = "Annual 2017 On-road CO2 emissions (mtons)
                    \nby Census block group by state",
                    padding = 5, align = "r") %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header"))
```


```{r boxplotCO2NE, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Boxplot of 7 Carbon Dioxoide (CO~2~) on-road emissions in metric tons per square kilometer (mtons/km^2^) by state at Census Block Group level.", include=FALSE}
...
```{r slopegraphCO2NE, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Total On-road CO~2~ emissions for 1990 and 2017 for New England."}
...
## Analysis of Diesel Particulate Matter ($mu$g/m^3^) in New England
...
```{r mapDPMNE, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Map of 2014 annual average ambient concentrations of Diesel Particulate Matter in micrograms per cubic meter ($mu$g/m^3^) across New England at Census Block Group level."}
...
Diesel Particulate Matter concentrations vary by state (see Table \@ref(tab:statsDPMNE) above and Figure \@ref(fig:boxplotDPMNE) below). Rhode Island shows the highest average ambient concentrations, although Massachusetts shows more extreme values.  

```{r statsDPMNE, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Annual 2014 average ambient concentrations of Diesel Particulate Matter in micrograms per cubic meter ($mu$g/m^3^) across New England at Census Block Group level."}
ne_blkgrp_sf %>%
  as.data.frame() %>% 
  group_by(STATE) %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    caption = "Annual 2014 DPM concentrations by Census block group", padding = 5, align = "r") %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header"))
```


```{r boxplotDPMNE, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Boxplot of 7 Carbon Dioxoide (CO~2~) on-road emissions in metric tons per square kilometer (mtons/km^2^) by state at Census Block Group level."}
# boxplot of CO2 by state for 2017
ne_blkgrp_sf %>% 
  as.data.frame() %>% 
...
```{r cormatrixDPMPopAvg, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Spearman's correlation matrix of annual average Diesel Particulate Matter concentrations and the proportions of populations of concern by Census Block Group.", include=FALSE}
# Create a correlation matrix of PM25 and populations of concern
...
Lifetime cancer risk from inhalation of air toxics vary by state (see Table \@ref(tab:statsATCNE) above and Figure \@ref(fig:boxplotATCNE) below). Massachusetts, Connecticut, and Rhode Island show the highest average lifetime cancer risks with similar median values. New Hampshire shows concentrations that are significantly higher than Maine and Vermont.   
...
```{r cormatrixATCPopAvg, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Spearman's correlation matrix of lifetime cancer risk and the proportions of populations of concern by Census Block Group.", include=FALSE}
...
## Analysis of Respiratory Hazard Index from Air Toxics in New England
...
Respiratory hazard indices vary by state (see Table \@ref(tab:statsRHINE) above and Figure \@ref(fig:boxplotRHINE) below). Massachusetts, Connecticut, and Rhode Island show the highest average lifetime respiratory hazard indices.  
...
```{r cormatrixRHIPopAvg, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Spearman's correlation matrix of lifetime cancer risk and the proportions of populations of concern by Census Block Group.",include=FALSE}
# Create a correlation matrix of cancer risk and populations of concern
corrACT <- ne_blkgrp_sf %>% 
  as.data.frame() %>% 
...
Traffic Proximity and Volume exposure vary by state (see Table \@ref(tab:statsTPVNE)). Massachusetts shows the highest Traffic Proximity and Volume exposure, followed distantly by Connecticut, and Rhode Island.  
...
```{r boxplotTPVNE, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Boxplot of 2017 traffic proximity and volume (calculated as a count of vehicles (average annual daily traffic) at major roads within 500 meters, divided by distance in kilometers (km)) across New England at Census Block Group level.",eval=FALSE,include=FALSE}
...
```{r cormatrixTPVPopAvg, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Spearman's correlation matrix of lifetime cancer risk and the proportions of populations of concern by Census Block Group.", eval=FALSE, include=FALSE}
# There is a moderate positive correlation between the proportions of minorities and traffic proximity and volume, and a moderate positive correlation with language isolated households (see Figure \@ref(fig:cormatrixTPVPopAvg) below.).
...
This is Appendix A where we describe the data and methodologies used in this analysis.

# Appendix B

Here are supplementary figures and tables.
