...
ne_blkgrp_sf %>% 
  ...
  geom_text(aes(x = "Under 5", y = 2.5, label = "Above regional average"),
            color = "gray48") +
  geom_segment(aes(x = "Low Income", xend = "Low Income", y = 0.5, yend = 2.5), 
               arrow = arrow(length = unit(0.3,"cm"))) +
  expand_limits(y = c(-1.5,6))
```
...
ne_blkgrp_sf %>% 
  ...
  scale_y_continuous(labels = function(x) paste0(x, "%")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  geom_text(aes(x = "Under 5", y = 2, label = "Above regional average"),
            color = "gray48") +
...
ne_blkgrp_sf %>% 
  ...
  scale_y_continuous(labels = function(x) paste0(x, "%")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  geom_text(aes(x = "Low Income", y = 20, label = "Above regional avg"),
            color = "gray48") +
...
ne_blkgrp_sf %>% 
  ...
  scale_y_continuous(labels = function(x) paste0(x, "%")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  geom_text(aes(x = "Under 5", y = 6, label = "Above regional average"),
            color = "gray48") +
...
ne_blkgrp_sf %>% 
  ...
  scale_y_continuous(labels = function(x) paste0(x, "%")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  geom_text(aes(x = "Low Income", y = 7, label = "Above regional average"),
            color = "gray48") +
  geom_segment(aes(x = "Under 5", xend = "Under 5", y = 2, yend = 7), 
               arrow = arrow(length = unit(0.3,"cm"))) +
  expand_limits(y = c(-4,16))
```
...
ne_blkgrp_sf %>% 
  ...
  scale_y_continuous(labels = function(x) paste0(x, "%")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  geom_text(aes(x = "No HS Dip", y = 60, label = "Above regional average"),
            color = "gray48") +
