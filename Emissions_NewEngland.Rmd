...
# acquire table of 1990 pop values
library(tidycensus)
...
The growth in CO~2~ emissions greatly exceeds population growth as is evident in the per capita emissions (see last three columns in Table \@ref(tab:changeCO2NE)). While New Hampshire leads in growth of total average emissions for the region, Vermont leads in per capita growth. Since 1990, Vermont's per capita CO~2~ emissions have increased more than 24 times. 
