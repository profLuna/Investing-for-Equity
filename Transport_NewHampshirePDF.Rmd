...
However, this access varies by population group. Figure \@ref(fig:loliBusDist) below compares the percentages of different population groups living within reasonable walking distance of bus routes across the state. Most populations of concern, including transit-dependent groups, have access similar to or better than the general population. However, note that people over age 64 and under 18 have less access on average compared to the general population.
...
```{r statsBusDist, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="New Hampshire populations living within 1/4 mile (400 meters) of a bus route. Based on ACS 2017 Block Group data."}
...
leastWalkable2 <- leastWalkable %>%
  ...
  arrange(desc(`Over 64`))
```
The population-weighted average walkability scores provide a glimpse of average walkability across the state for different population groups. However, walkability also varies for specific communities. Indeed, it is important to consider populations of concern that reside in communities with low walkability. Figures \@ref(fig:mapLowWalkU18) and  \@ref(fig:mapLowWalkO64) below highlight Census Block Groups across New Hampshire that are least walkable and the numbers of persons under 18 or over 64 that live there. Tables \@ref(tab:tabLowWalkU18) and \@ref(tab:tabLowWalkO64) show breakdowns by municipality. For example, Table \@ref(tab:tabLowWalkU18) shows that `r formatC(as.numeric(leastWalkable1[1,3]),big.mark=",")` people under 18 across `r leastWalkable1[1,2]` Block Groups in `r leastWalkable1[1,1]` resided in the least walkable areas. These people represented `r leastWalkable1[1,4]` of people under 18 in `r leastWalkable1[1,1]`. Similarly, Table \@ref(tab:tabLowWalkO64) shows that `r formatC(as.numeric(leastWalkable2[1,3]),big.mark=",")` people over 64 across `r leastWalkable2[1,2]` Block Groups in `r leastWalkable2[1,1]` resided the least walkable areas. These people represented `r leastWalkable2[1,4]` of people over 64 in `r leastWalkable2[1,1]`.
...
Figure \@ref(fig:mapLAI) below shows transportation cost burden (i.e., transportation cost as a percentage of household income) by Census Tract across New Hampshire. Transportation cost burden varies across the state. It is lowest in and around Salem, Nashua, Manchester, Concord, and Portsmouth. In `r nrow(lai_ToverH)` Census Tracts, the transportation cost burden exceeds the cost burden of housing. 

```{r mapLAI, fig.align = "center", fig.cap="Transportation cost burden for Census Tracts across New Hampshire."}
m <- tm_shape(lai_ri) +
...
tmap_save(m, "DATA/transport/NH/figures/nh_tburden.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_tburden.png")
````

Transportation cost burden varies for different population groups across the state. Figure \@ref(fig:loliLAI) below compares population-weighted average transportation cost burden for different populations. Most groups live in communities with transportation cost burdens that are below that of the general population. However, persons over age 64 and disabled persons tend to live in communities with transportation cost burdens that exceed that of the general population of the state. 

```{r loliLAI, fig.align = "center", fig.cap="Population-weighted average transportation cost burden for groups across New Hampshire."}
...
lai_nh_df %>% 
  ...
  geom_segment(aes(x = reorder(Group,wTBurden), 
                   ...
                   y = pull(lai_nh_df[6,2]), yend = wTBurden), 
               color = "coral4") +
...
```
The population-weighted average transportation cost burden values provide a glimpse of average transportation cost burden across the state for different population groups. However, transportation cost burden also varies for specific communities. Indeed, it is important to consider populations of concern that reside in communities with a high transportation cost burden. Figures \@ref(fig:mapHiBurdenO64) and \@ref(fig:mapHiBurdenDisabled) below highlight Census Block Groups across New Hampshire where the transportation cost burden is in the highest quintile (i.e., 80th percentile) and the numbers of persons over 64 or disabled that live there. Tables \@ref(tab:tabHiBurdenO64) and \@ref(tab:tabHiBurdenDisabled) show breakdowns by municipality. For example, Table \@ref(tab:tabHiBurdenO64) shows that `r formatC(as.numeric(HiBurden1[1,3]),big.mark=",")` people over 64 across `r HiBurden1[1,2]` Block Groups in `r HiBurden1[1,1]` resided in areas with the highest transportation cost burden. These people represented `r HiBurden1[1,4]` of people over 64 in `r HiBurden1[1,1]`. Similarly, Table \@ref(tab:tabHiBurdenDisabled) shows that `r formatC(as.numeric(HiBurden2[1,3]),big.mark=",")` disabled persons across `r HiBurden2[1,2]` Block Groups in `r HiBurden2[1,1]` resided in areas with the highest transportation cost burden. These people represented `r HiBurden2[1,4]` of disabled persons in `r HiBurden2[1,1]`.
...
tmap_save(m, "DATA/transport/NH/figures/nh_HiBurdenO64.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_HiBurdenO64.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_HiBurdenDisabled.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_HiBurdenDisabled.png")
```
...
Routes for local bus routes in New Hampshire were manually digitized from online route maps distributed by their respective transit agencies. At the time of this analysis, geospatial data on transit routes in New Hampshire were not otherwise publicly available. Special thanks to Bradford Newton for digitizing this data. 
...
## No Transit Access and Populations of Concner {-}
...
m <- tm_shape(nh_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(nh_tracts_sf_noBus_simple, unit = "mi") +
...
tmap_save(m, "DATA/transport/NH/figures/nh_transitDisabledaccess.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_transitDisabledaccess.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_transitU5access.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_transitU5access.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_transitLTHSaccess.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_transitLTHSaccess.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_transitINCaccess.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_transitINCaccess.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_transitNoCarHHaccess.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_transitNoCarHHaccess.png")
```
...
```{r mapTransitAccessMIN, fig.align = "center", fig.cap="Minority persons who are one or more miles from the nearest bus route by Census Block Group."}
m <- tm_shape(nh_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(nh_blkgrps_sf_noBus_simple, unit = "mi") +
...
tmap_save(m, "DATA/transport/NH/figures/nh_transitMINaccess.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_transitMINaccess.png")
```

```{r tabTransitAccessMIN, fig.align = "center", fig.cap="Minority persons in Census Block Groups one or more miles from the nearest bus route."}
nh_blkgrps_sf_noBus %>%
  st_centroid(.) %>% 
  st_intersection(nh_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "Minority Persons One or More Miles from Nearest Bus Route", align = "r", 
...
tmap_save(m, "DATA/transport/NH/figures/nh_transitLEHaccess.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_transitLEHaccess.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_walkU5.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_walkU5.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_walkLTHS.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_walkLTHS.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_walkDisabled.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_walkDisabled.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_walkINC.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_walkINC.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_walkMIN.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_walkMIN.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_walkLEH.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_walkLEH.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_walkNoCarHH.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_walkNoCarHH.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_HiBurdenLTHS.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_HiBurdenLTHS.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_HiBurdenU18.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_HiBurdenU18.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_HiBurdenU5.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_HiBurdenU5.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_HiBurdenINC.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_HiBurdenINC.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_HiBurdenNoCarHH.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_HiBurdenNoCarHH.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_HiBurdenMIN.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_HiBurdenMIN.png")
```
...
tmap_save(m, "DATA/transport/NH/figures/nh_HiBurdenLEH.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/NH/figures/nh_HiBurdenLEH.png")
```
