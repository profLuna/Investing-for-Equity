...
tmap_save(m, "DATA/transport/ri_transit.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_transit.png")
```
...
However, this access varies by population group. Figure \@ref(fig:loliBusDist) below compares the percentages of different population groups living within reasonable walking distance of bus stops across the state. Most populations of concern, including transit-dependent groups, have access similar to or better than the general population. However, note that people over age 64 have less access on average compared to the general population.
...
```{r statsBusDist, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="Rhode Island populations living within 1/4 mile (400 meters) of a bus stop. Based on ACS 2017 Block Group data."}
...
Maps and tables of other populations of concern without access to transit can be found in Appendix B.
...
tmap_save(m, "DATA/transport/ri_transitO64access.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_transitO64access.png")
```
...
tmap_save(m, "DATA/transport/ri_transitDisabledaccess.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_transitDisabledaccess.png")
```
...
ri_transit <- read_gtfs("DATA/transport/RIPTA062019gtfs.zip") %>% 
  gtfs_as_sf()
...
tmap_save(m, "DATA/transport/ri_transitHeadways.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_transitHeadways.png")
```
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  ...
  tm_layout(title = paste("Persons Over 64","with Headways",paste0("Over ",quantile(ri_routes_sf$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))

tmap_save(m, "DATA/transport/ri_headwayOver64.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_headwayOver64.png")
```
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  ...
  tm_scale_bar(breaks = c(0, 5, 10), text.size = 0.5, 
               position = c(0.6,0.005)) +
  tm_add_legend(type = "line", lwd=1, alpha = 0.3, labels = "Transit Route") +
  tm_layout(title = paste("Disabled Persons","with Headways",paste0("Over ",quantile(ri_routes_sf$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))

tmap_save(m, "DATA/transport/ri_headwayDisabled.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_headwayDisabled.png")
```
...
Figure \@ref(fig:mapWalkability) shows walkability scores by Census Block Group across Rhode Island.  Walkability varies across the state. It is highest in and around the state's major urban centers, such as Providence, Portsmouth, and Newport, and lowest in the western suburbs.
...
tmap_save(m, "DATA/transport/ri_walk.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_walk.png")
```

Walkability varies for different population groups across the state. Figure \@ref(fig:loliWalkability) below compares population-weighted average walkability index scores for different populations. Most groups live in communities with above average walkability index scores that are also at or above that of the general population. However, persons over age 64 tend to live in communities with walkability scores below the state average. 
...
```
The population-weighted average walkability scores provide a glimpse of average walkability across the state for different population groups. However, walkability also varies for specific communities. Indeed, it is important to consider populations of concern that reside in communities with low walkability. Figures \@ref(fig:mapLowWalkO64) and \@ref(fig:mapLowWalkUnder18) below highlight Census Block Groups across Rhode Island that are least walkable and the numbers of persons over 64 or under 18 live there. Tables \@ref(tab:tabLowWalkO64) and \@ref(tab:tabLowWalkUnder18) show breakdowns by municipality. For example, Table \@ref(tab:tabLowWalkO64) shows that `r formatC(as.numeric(leastWalkable1[1,3]),big.mark=",")` people over 64 across `r leastWalkable1[1,2]` Block Groups in `r leastWalkable1[1,1]` resided in the least walkable areas. These people represented `r leastWalkable1[1,4]` of people over 64 in `r leastWalkable1[1,1]`. Similarly, Table \@ref(tab:tabLowWalkUnder18) shows that `r formatC(as.numeric(leastWalkable2[1,3]),big.mark=",")` people under 18 across `r TransitNoAccess1[1,2]` Block Groups in `r leastWalkable2[1,1]` resided the least walkable areas. These people represented `r leastWalkable2[1,4]` of people under 18 in `r leastWalkable2[1,1]`.
...
tmap_save(m, "DATA/transport/ri_walkO64.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_walkO64.png")
```
...
tmap_save(m, "DATA/transport/ri_walkU18.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_walkU18.png")
```
...
```{r mapLAI, fig.align = "center", fig.cap="Transpotation cost burden for Census Tracts across Rhode Island."}
...
tmap_save(m, "DATA/transport/ri_tburden.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_tburden.png")
````
...
```{r loliLAI, fig.align = "center", fig.cap="Population-weighted average transportation cost burden for groups across Rhode Island."}
...
HiBurden2 <- HiBurden %>%
  ...
  arrange(desc(`Under 18`))
```
The population-weighted average transportation cost burden values provide a glimpse of average transportation cost burden across the state for different population groups. However, transportation cost burden also varies for specific communities. Indeed, it is important to consider populations of concern that reside in communities with a high transportation cost burden. Figures \@ref(fig:mapHiBurdenO64) and \@ref(fig:mapHiBurdenUnder18) below highlight Census Block Groups across Rhode Island where the transportation cost burden is in the highest quintile (i.e., 80th percentile) and the numbers of persons over 64 or under 18 that live there. Tables \@ref(tab:tabHiBurdenO64) and \@ref(tab:tabHiBurdenUnder18) show breakdowns by municipality. For example, Table \@ref(tab:tabHiBurdenO64) shows that `r formatC(as.numeric(HiBurden1[1,3]),big.mark=",")` people over 64 across `r HiBurden1[1,2]` Block Groups in `r HiBurden1[1,1]` resided in areas with the highest transportation cost burden. These people represented `r HiBurden1[1,4]` of people over 64 in `r HiBurden1[1,1]`. Similarly, Table \@ref(tab:tabHiBurdenUnder18) shows that `r formatC(as.numeric(HiBurden2[1,3]),big.mark=",")` people under 18 across `r HiBurden2[1,2]` Block Groups in `r HiBurden2[1,1]` resided in areas with the highest transportation cost burden. These people represented `r HiBurden2[1,4]` of people under 18 in `r HiBurden2[1,1]`.
...
tmap_save(m, "DATA/transport/ri_HiBurdenO64.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_HiBurdenO64.png")
```
...
tmap_save(m, "DATA/transport/ri_HiBurdenU18.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_HiBurdenU18.png")
```
...
tmap_save(m, "DATA/transport/ri_transitU18access.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_transitU18access.png")
```
...
tmap_save(m, "DATA/transport/ri_transitU5access.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_transitU5access.png")
```
...
tmap_save(m, "DATA/transport/ri_transitNOHSaccess.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_transitNOHSaccess.png")
```
...
tmap_save(m, "DATA/transport/ri_transitINCaccess.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_transitINCaccess.png")
```
...
tmap_save(m, "DATA/transport/ri_transitNoCaraccess.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_transitNoCaraccess.png")
```
...
```{r mapTransitAccessMIN, fig.align = "center", fig.cap="Minority persons who are one or more miles from the nearest transit stop by Census Block Group."}
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(ri_blkgrps_sf_noBus, unit = "mi") +
...
tmap_save(m, "DATA/transport/ri_transitMINaccess.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_transitMINaccess.png")
```

```{r tabTransitAccessMIN, fig.align = "center", fig.cap="Minority persons in Census Block Groups one or more miles from the nearest bus stop."}
ri_blkgrps_sf_noBus %>%
  st_centroid(.) %>% 
  st_intersection(ri_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "Minority Persons One or More Miles from Nearest Transit Stop", align = "r", col.names = c(names(.)[1:2],"Number of Minorities in Block Groups","Pct of Minorities in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped")) 
```
...
tmap_save(m, "DATA/transport/ri_transitLEHaccess.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_transitLEHaccess.png")
```
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  ...
  tm_scale_bar(breaks = c(0, 5, 10), text.size = 0.5, 
               position = c(0.6,0.005)) +
  tm_add_legend(type = "line", lwd=1, alpha = 0.3, labels = "Transit Route") +
  tm_layout(title = paste("Persons Under 18","with Headways",paste0("Over ",quantile(ri_routes_sf$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))

tmap_save(m, "DATA/transport/ri_headwayU18.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_headwayU18.png")
```
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  ...
  tm_scale_bar(breaks = c(0, 5, 10), text.size = 0.5, 
               position = c(0.6,0.005)) +
  tm_add_legend(type = "line", lwd=1, alpha = 0.3, labels = "Transit Route") +
  tm_layout(title = paste("Households","without a Car","with Headways",paste0("Over ",quantile(ri_routes_sf$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))

tmap_save(m, "DATA/transport/ri_headwayNoCar.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_headwayNoCar.png")
```
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  ...
  tm_scale_bar(breaks = c(0, 5, 10), text.size = 0.5, 
               position = c(0.6,0.005)) +
  tm_add_legend(type = "line", lwd=1, alpha = 0.3, labels = "Transit Route") +
  tm_layout(title = paste("Children Under 5","with Headways",paste0("Over ",quantile(ri_routes_sf$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))

tmap_save(m, "DATA/transport/ri_headwayUnder5.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_headwayUnder5.png")
```
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  ...
  tm_scale_bar(breaks = c(0, 5, 10), text.size = 0.5, 
               position = c(0.6,0.005)) +
  tm_add_legend(type = "line", lwd=1, alpha = 0.3, labels = "Transit Route") +
  tm_layout(title = paste("Low Income Persons","with Headways",paste0("Over ",quantile(ri_routes_sf$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))

tmap_save(m, "DATA/transport/ri_headwayLowInc.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_headwayLowInc.png")
```
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  ...
  tm_scale_bar(breaks = c(0, 5, 10), text.size = 0.5, 
               position = c(0.6,0.005)) +
  tm_add_legend(type = "line", lwd=1, alpha = 0.3, labels = "Transit Route") +
  tm_layout(title = paste("Adults without a","High School Diploma","with Headways",paste0("Over ",quantile(ri_routes_sf$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))

tmap_save(m, "DATA/transport/ri_headwayNoHSDip.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_headwayNoHSDip.png")
```
...
```{r mapHeadwayMinority, fig.align = "center", fig.cap="Minority persons within 400m or 1/4 mile of transit stops in which the mean headway for these stops is above the 80th percentile for the state."}
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(headway80thblkgrps) +
  tm_fill(col = "NewMinority", alpha = 0.9, style = "quantile",
  ...
  tm_scale_bar(breaks = c(0, 5, 10), text.size = 0.5, 
               position = c(0.6,0.005)) +
  tm_add_legend(type = "line", lwd=1, alpha = 0.3, labels = "Transit Route") +
  tm_layout(title = paste("Minority Persons","with Headways",paste0("Over ",quantile(ri_routes_sf$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))

tmap_save(m, "DATA/transport/ri_headwayMinority.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_headwayMinority.png")
```

```{r tabHeadwayMinority, fig.align = "center", fig.cap="Minority persons within 400m or 1/4 mile of transit stops in which the mean headway for these stops is above the 80th percentile for the state."}
headway80thblkgrps %>%
  st_centroid(.) %>% 
  st_intersection(ri_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = paste("Minority Persons","with Headways",paste0("Over ",quantile(ri_routes_sf$mean_headways,0.8)," Minutes"),sep = "\n"), align = "r", col.names = c(names(.)[1:2],"Number of Minorities in Block Groups","Pct of Minorities in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  ...
  tm_scale_bar(breaks = c(0, 5, 10), text.size = 0.5, 
               position = c(0.6,0.005)) +
  tm_add_legend(type = "line", lwd=1, alpha = 0.3, labels = "Transit Route") +
  tm_layout(title = paste("Limited English","Speaking Households","with Headways",paste0("Over ",quantile(ri_routes_sf$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))

tmap_save(m, "DATA/transport/ri_headwayLEH.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_headwayLEH.png")
```
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  ...
  tm_scale_bar(breaks = c(0, 5, 10), text.size = 0.5, 
               position = c(0.6,0.005)) +
  tm_add_legend(type = "line", lwd=1, alpha = 0.3, labels = "Transit Route") +
  tm_layout(title = paste("RI Low Income Persons","with Headways",paste0("Over ",quantile(ri_routes_sf$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))

tmap_save(m, "DATA/transport/ri_headwayRILowInc.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_headwayRILowInc.png")
```
...
```{r mapHeadwayRIMinority, fig.align = "center", fig.cap="Minority persons, as defined by the state's environmental justice policy, within 400m or 1/4 mile of transit stops in which the mean headway for these stops is above the 80th percentile for the state."}
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(headway80thblkgrps) +
  ...
  tm_scale_bar(breaks = c(0, 5, 10), text.size = 0.5, 
               position = c(0.6,0.005)) +
  tm_add_legend(type = "line", lwd=1, alpha = 0.3, labels = "Transit Route") +
  tm_layout(title = paste("RI Minority Persons","with Headways",paste0("Over ",quantile(ri_routes_sf$mean_headways,0.8)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))

tmap_save(m, "DATA/transport/ri_headwayRIMinority.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_headwayRIMinority.png")
```

```{r tabHeadwayRIMinority, fig.align = "center", fig.cap="Minority persons, as defined by the state's environmental justice policy, within 400m or 1/4 mile of transit stops in which the mean headway for these stops is above the 80th percentile for the state."}
headway80thblkgrps %>%
  st_centroid(.) %>% 
  st_intersection(ri_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = paste("RI Minority Persons","with Headways",paste0("Over ",quantile(ri_routes_sf$mean_headways,0.8)," Minutes"),sep = "\n"), align = "r", col.names = c(names(.)[1:2],"Number of RI Minorities in Block Groups","Pct of RI Minorities in City/Town")) %>% 
  kableExtra::column_spec(3:4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
```
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  ...
  tm_fill(col = "disabledOver18E", alpha = 0.9, style = "quantile",
...
tmap_save(m, "DATA/transport/ri_walkDisabled.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_walkDisabled.png")
```
...
tmap_save(m, "DATA/transport/ri_walkU5.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_walkU5.png")
```
...
tmap_save(m, "DATA/transport/ri_walkNoHSDip.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_walkNoHSDip.png")
```
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(leastWalkable, unit = "mi") +
  tm_fill(col = "num2povE", alpha = 0.9, style = "quantile",
...
tmap_save(m, "DATA/transport/ri_walkLowInc.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_walkLowInc.png")
```
...
tmap_save(m, "DATA/transport/ri_walkNoCar.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_walkNoCar.png")
```
...
tmap_save(m, "DATA/transport/ri_walkMinority.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_walkMinority.png")
```
...
tmap_save(m, "DATA/transport/ri_walkLEH.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_walkLEH.png")
```
...
tmap_save(m, "DATA/transport/ri_HiBurdenDisabled.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_HiBurdenDisabled.png")
```
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(HiBurden, unit = "mi") +
  tm_fill(col = "under5E", alpha = 0.9, style = "quantile",
          colorNA = "white", colorNULL = "gray", title = "Children Under 5\nPer Square Kilometer",
          legend.format = list(fun = function(x) formatC(x, digits = 0, format = "f")), palette = "OrRd", convert2density = TRUE, area = "SqKm") +
  tm_shape(ri_tracts_sf) + tm_borders(alpha = 0.5, lwd = 0.2) +
  tm_shape(ne_states_sf_cb) + tm_borders(lwd = 0.2, alpha = 0.8) + 
...
tmap_save(m, "DATA/transport/ri_HiBurdenU5.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_HiBurdenU5.png")
```
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(HiBurden, unit = "mi") +
  tm_fill(col = "lthsE", alpha = 0.9, style = "quantile",
...
tmap_save(m, "DATA/transport/ri_HiBurdenLTHS.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_HiBurdenLTHS.png")
```
...
tmap_save(m, "DATA/transport/ri_HiBurdenINC.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_HiBurdenINC.png")
```
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(HiBurdenTract, unit = "mi") +
  tm_fill(col = "HHnoCarE", alpha = 0.9, style = "quantile",
...
tmap_save(m, "DATA/transport/ri_HiBurdenNoCarHH.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_HiBurdenNoCarHH.png")
```
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  tm_fill(col = "gray",alpha = 0.2) +
  tm_shape(HiBurden, unit = "mi") +
  tm_fill(col = "minorityE", alpha = 0.9, style = "quantile",
          colorNA = "white", colorNULL = "gray", title = "Minority Persons\nPer Square Kilometer",
          legend.format = list(fun = function(x) formatC(x, digits = 0, format = "f")), palette = "OrRd", convert2density = TRUE, area = "SqKm") +
  tm_shape(ri_tracts_sf) + tm_borders(alpha = 0.5, lwd = 0.2) +
  tm_shape(ne_states_sf_cb) + tm_borders(lwd = 0.2, alpha = 0.8) + 
...
tmap_save(m, "DATA/transport/ri_HiBurdenMIN.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_HiBurdenMIN.png")
```
...
tmap_save(m, "DATA/transport/ri_HiBurdenLEH.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_HiBurdenLEH.png")
```
...
tmap_save(m, "DATA/transport/ri_HiBurdenRIINC.png",
          height = 8, width = 8, units = "in", dpi = 600)

knitr::include_graphics("DATA/transport/ri_HiBurdenRIINC.png")
```
