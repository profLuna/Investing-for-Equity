...
ggsave("DATA/transport/RI/figures/ri_headwayBus_lolli.png")
```
...
save(headway80thblkgrps,
     headway80thtracts,file = "DATA/transport/CT/headway80th.Rds")
...
ggsave("DATA/transport/RI/figures/ri_tburden_lolli.png")
```
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  ...
  tm_scale_bar(breaks = c(0, 5, 10), text.size = 0.5, 
               position = c(0.6,0.005)) +
  tm_add_legend(type = "line", lwd=1, alpha = 0.3, labels = "Transit Route") +
  tm_layout(title = paste("Minority Persons","with Headways",paste0("Over ",round(quantile(ri_routes_sf$mean_headways,0.8),0)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))
...
m <- tm_shape(ri_state_sf_cb, unit = "mi") + 
  ...
  tm_scale_bar(breaks = c(0, 5, 10), text.size = 0.5, 
               position = c(0.6,0.005)) +
  tm_add_legend(type = "line", lwd=1, alpha = 0.3, labels = "Transit Route") +
  tm_layout(title = paste("RI Minority", "Persons with","Headways Over",paste0(round(quantile(ri_routes_sf$mean_headways,0.8),0)," Minutes"),sep = "\n"), 
            frame = FALSE, main.title.size = 0.8,
            legend.outside = TRUE,
            legend.title.size = 0.8,
            legend.outside.position = c("right", "top"))
