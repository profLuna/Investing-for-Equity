...
Some groups are disproportionately exposed to these hurricane evacuation hazards. While approximately 14.1% of the general population are living within hurricane evacuation zones, people in limited English speaking households, households without access to a car, People of Color, people in low income households, adults with less than a high school education, and other priority populations exceed the population average living within hurricane evacuation zones. These priority populations are disproportionately exposed to hurricane evacuation risk (see Figure \@ref(fig:chartHEVACpop)).
...
ggsave("images/MA_HEVAC_graph.png")
```
...
```{r mapNFHZAPopConcern7, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="People of Color, as Defined by the Massachusetts Environmental Justice Policy, Living within Flood Zones."}
# Create data subset
nfhza_sub <- ma_nfhza_vulnerable %>% 
...
```{r tabNFHZAMAMIN, fig.align = "center", fig.cap="People of Color, as Defined by the Massachusetts Environmental Justice Policy, living within FEMA Flood Zones."}
ma_blkgrps_nfhza %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "MA People of Color Living in FEMA Flood Zones", align = "r", col.names = c("City/Town", "MA POC", "Pct of MA POC")) %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
```
...
```{r mapNFHZAPopConcern9, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="People of Color Living within Flood Zones."}
# Create data subset
nfhza_sub <- ma_nfhza_vulnerable %>% 
...
```{r mapHEVACPopConcern7, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="People of Color, as Defined by the Massachusetts Environmental Justice Policy, Living within Flood Zones."}
# Create data subset
hevac_sub <- ma_hevac_vulnerable %>% 
  filter(Group == "MA Minority")
...
```{r tabHEVACMAMIN, fig.align = "center", fig.cap="People of Color, as Defined by the Massachusetts Environmental Justice Policy, living within Hurricane Evacuation Zones."}
ma_blkgrps_hevac %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "MA Minority Persons Living in Hurricane Evacuation Zones", align = "r", col.names = c("City/Town", "MA POC", "Pct of MA POC")) %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
```
...
```{r mapHEVACPopConcern9, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.cap="People of Color Living within Flood Zones."}
# Create data subset
hevac_sub <- ma_hevac_vulnerable %>% 
  filter(Group == "Minority")
...
ma_blkgrps_hevac %>% 
  ...
  kableExtra::kable(longtable = T, booktabs = T,
                    format.args = list(big.mark = ','), 
                    digits = 1,
                    caption = "People of Color Living in Hurricane Evacuation Zones", align = "r", col.names = c("City/Town", "People of Color", "Pct of POC")) %>% 
  kableExtra::kable_styling(latex_options = c("repeat_header","striped"))
```
