...
The maps below (Figures \@ref(fig:mapHEVACPopConcern1) and \@ref(fig:mapHEVACPopConcern2)) show limited English speaking households and households without a car which are disproportionately exposed to flood risk. Maps for other populations of concern can be found in Figures \@ref(fig:mapHEVACPopConcern3) to \@ref(fig:mapHEVACPopConcern12) as well as breakdowns by municipality in Tables \@ref(tab:tabNFHZA_MALEH) to \@ref(tab:mapHEVACPopConcern12) in Appendix B.
...
```{r tabNFHZA_MALEH, fig.align = "center", fig.cap="Limited English Speaking Housheolds, as Defined by the Massachusetts Environmental Justice Policy, living within FEMA Flood Zones."}
ma_blkgrps_nfhza %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
...
```{r tabNFHZA_MANoCar, fig.align = "center", fig.cap="Households without a car living within FEMA Flood Zones."}
ma_tracts_nfhza %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
...
```{r tabNFHZA_LEH, fig.align = "center", fig.cap="Limited English Speaking Housheolds living within FEMA Flood Zones."}
ma_blkgrps_nfhza %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
...
```{r tabNFHZA_LTHS, fig.align = "center", fig.cap="Adults without a High School Diploma living within FEMA Flood Zones."}
ma_blkgrps_nfhza %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
...
```{r tabNFHZA_LINC, fig.align = "center", fig.cap="Low Income Persons living within FEMA Flood Zones."}
ma_blkgrps_nfhza %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
...
```{r tabNFHZA_DIS, fig.align = "center", fig.cap="Disabled Persons living within FEMA Flood Zones."}
ma_tracts_nfhza %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
...
```{r tabNFHZA_MAMIN, fig.align = "center", fig.cap="Minority Persons, as Defined by the Massachusetts Environmental Justice Policy, living within FEMA Flood Zones."}
ma_blkgrps_nfhza %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
...
```{r tabNFHZA_MALINC, fig.align = "center", fig.cap="Low Income Persons, as Defined by the Massachusetts Environmental Justice Policy, living within FEMA Flood Zones."}
ma_blkgrps_nfhza %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
...
```{r tabNFHZA_MIN, fig.align = "center", fig.cap="Minority Persons living within FEMA Flood Zones."}
ma_blkgrps_nfhza %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
...
```{r tabNFHZA_U5, fig.align = "center", fig.cap="Children Under 5 living within FEMA Flood Zones."}
ma_blkgrps_nfhza %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
...
```{r tabNFHZA_O64, fig.align = "center", fig.cap="Persons Over 64 living within FEMA Flood Zones."}
ma_blkgrps_nfhza %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
...
```{r tabNFHZA_U18, fig.align = "center", fig.cap="Persons Under 18 living within FEMA Flood Zones."}
ma_blkgrps_nfhza %>% 
  st_centroid(.) %>% 
  st_intersection(ma_towns_sf,.) %>% 
  as.data.frame() %>% 
